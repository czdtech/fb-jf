...
국가 대표 팀을 선택해 월드컵 형식의 토너먼트에 참가할 수 있습니다.

<!-- i18n:section:how-to-play -->
### 플레이 방법

- 짧은 패스: 인접한 라인 사이로 공을 톡톡 연결한 뒤, 빠르게 슛으로 마무리하세요.  
- 수비 라인 커버: 수비수는 중앙 라인을 막아 두고, 필요할 때만 움직여 빈 공간을 줄입니다.  
- 각도 슛: 발끝 바깥쪽으로 공을 쳐서 먼 포스트 각도를 노리면 득점 확률이 올라갑니다.  
- 무리한 연속 회전 자제: 막대를 계속 회전시키면 정확도가 떨어질 수 있으니, 컨트롤이 될 만큼만 회전하세요.  
- 킥오프 대각 슛: 상대가 자리 잡기 전에, 킥오프 직후 대각선으로 빠르게 슛을 시도해 보세요.  


<!-- i18n:section:controls -->
### 조작 방법
<!-- i18n:controls:keys -->
- 키(정렬)： `WASD` `mouse` `drag` `Tap`
...
- 무작정 강하게만 회전시키기보다, 공의 위치와 각도를 보고 정확한 방향으로
  슛이나 패스를 시도하는 것이 중요합니다.  
- 수비 시에는 골문 앞 막대를 중심으로 위치를 잡고, 상대 공격 방향에 맞춰
  살짝씩 움직이며 커버해 주세요.  
