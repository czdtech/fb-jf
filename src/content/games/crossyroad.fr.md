...
1.  **Regarde plusieurs lignes à l’avance**  
    Ne te focalise pas uniquement sur la voiture juste devant toi : anticipe les
    flux de trafic sur les deux ou trois rangées suivantes.
2.  **Évite de rester immobile trop longtemps**  
    Dans certaines versions, l’écran avance tout seul ou un aigle vient te
    punir si tu attends trop.
3.  **Traverse en diagonale quand c’est utile**  
    Parfois, alterner gauche/droite/avant permet de suivre un "couloir" sûr
    entre les véhicules.
4.  **Sur les troncs de rivière, garde le contrôle**  
...
R : Non, Crossy Road est conçu comme un runner infini. L’objectif est de battre
