...
title: '[ES] Cricket World Cup'
description: >-
  [ES] Cricket World Cup condenses batting drills — pick shots, read
...
1.  **[ES]** Shot selection by line: Leg‑side late glances vs pads; off‑side drives for wide lines.
2.  **[ES]** Risk management: Favor ground shots when deep fielders are set.
3.  **[ES]** Rotate strike: Take singles to keep the board moving when boundaries dry up.
4.  **[ES]** Power plays: Attack gaps when field is up.
5.  **[ES]** Watch bowler rhythm: Time swings from release, not only ball flight.
