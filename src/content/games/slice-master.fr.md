...
locale: fr
urlstr: slice-master
title: '[FR] Slice Master'
description: >-
  [FR] Slice Master is a satisfying physics-based game where players control a
...
1.  **[FR]** **Master Cutting Timing**: Learn to cut at the right moments to ensure maximum scoring and effectiveness.
2.  **[FR]** **Object Recognition**: Identify cuttable and non-cuttable objects, avoiding collision with obstacles.
3.  **[FR]** **Angle Control**: Adjust the knife's angle to achieve optimal cutting effects.
4.  **[FR]** **Combo System**: Build consecutive successful cuts to earn higher score bonuses.
5.  **[FR]** **Collect Items**: Gather special items and coins in levels to enhance abilities.

### How to Play

*   **[FR]** **Direction Control**: Typically use mouse or touch to control the knife's movement direction.
*   **[FR]** **Cutting Action**: Click or swipe to perform cutting actions.
*   **[FR]** **Angle Adjustment**: Drag to adjust the knife's angle and trajectory.

### Frequently Asked Questions

1.  **[FR]** **Q: How do I get perfect cuts?**
**A**: Observe the shape and texture of objects, find the optimal cutting line, and maintain steady gestures.
2.  **[FR]** **Q: What happens if I hit obstacles?**
**A**: Hitting obstacles will reduce health or cause game over; you need to carefully avoid them.
3.  **[FR]** **Q: Are there different knives in the game?**
**A**: Many versions offer different knives with various appearances and attributes for players to unlock and use.
4.  **[FR]** **Q: How can I improve my score?**
