...
Dans Daily Word Climb, tu reçois un ensemble de lettres et tu dois former un
certain nombre de mots pour passer au niveau suivant. Chaque jour, un nouveau
ensemble te met au défi.

Les mots valides remplissent des cases, un peu comme dans un mini mot croisé ou
un jeu de lettres à relier.

### Guide de jeu

1.  **Commence par les mots évidents**  
    Cherche d’abord les mots courts et fréquents pour te mettre en route.
...
- **Valider** : relâche ou appuie sur le bouton de validation pour soumettre le
  mot.
...
**Q : Puis‑je rejouer le défi du jour ?**  
R : Oui, tu peux en général rejouer la grille du jour autant de fois que tu le
souhaites pour améliorer ton score.
