...
2.  Target multipliers: Hit +ball pickups early to scale your volleys.
3.  Cut columns: Remove high‑value columns that threaten the bottom.
4.  Set traps: Build V‑shaped lanes so balls loop near the top for extended time on target.
