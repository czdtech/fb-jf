...
title: '[DE] Stars Aligned'
description: >-
  [DE] Stars Aligned is a soothing constellation puzzler — rotate fragments,
...
1.  **[DE]** Start with anchors: Lock obvious matches first to reduce possibilities.
2.  **[DE]** Check all rotations: Slight orientation changes often reveal hidden fits.
3.  **[DE]** Symmetry cues: Many constellations are symmetric—use mirroring to test placements.
4.  **[DE]** Isolate sub‑graphs: Solve small connected groups before linking the whole.
5.  **[DE]** Zoom for precision: Use any zoom to verify nearly‑aligned joints.
