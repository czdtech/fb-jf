...
1.  **Surveiller les caméras :** bascule régulièrement d’une caméra à l’autre pour repérer tôt les anomalies et ne pas te faire surprendre à la dernière seconde.  
2.  **Gérer l’énergie :** le courant est limité. Éteins les lumières inutiles et évite d’abuser des portes ou systèmes gourmands en énergie.  
3.  **Bloquer les accès :** lorsqu’une menace se rapproche d’un couloir, ferme rapidement la porte correspondante ou active la protection locale pour l’empêcher d’entrer dans ton bureau.  
4.  **Écouter les sons :** les bruits de pas, grincements ou respirations donnent souvent plus d’informations que l’image ; serre‑toi du son pour savoir d’où vient le danger.  
...
1.  **Q : Quel est l’objectif du jeu ?**  
   **R :** Survivre à chaque nuit jusqu’au matin sans que les créatures n’atteignent ton bureau.

2.  **Q : Comment gérer les différents types de menaces ?**  
   **R :** Observe leurs timings, les caméras qu’elles utilisent et leurs angles d’attaque favoris. Certaines nécessitent plus de surveillance visuelle, d’autres se trahissent surtout par le son.

3.  **Q : Que se passe‑t‑il si le courant est coupé ?**  
   **R :** Les caméras et protections cessent de fonctionner, ce qui te laisse presque sans défense. Il est donc crucial de conserver un minimum d’énergie jusqu’à la fin de la nuit.
