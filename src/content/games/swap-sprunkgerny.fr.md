...
Tu rêves de diriger un orchestre d’aliens aux grands yeux ? Swap Sprunkgerny
te place aux commandes d’un groupe de créatures excentriques, chacune avec son
propre son et sa petite chorégraphie.

### Cœur du gameplay

- **Glisse les personnages :** choisis parmi 20 personnages en bas de l’écran
  et dépose‑les sur l’un des 7 emplacements en haut.

### The Core Gameplay of SWAP SPRUNKGERNY:
- **Anime la scène :** une fois posés, ils prennent vie, jouent leur boucle et
  dansent.
- **Crée ton mix :** change les combinaisons pour obtenir des ambiances
...
Swap Sprunkgerny mise sur la simplicité du drag‑and‑drop et le plaisir de voir
et d’entendre ton orchestration évoluer en temps réel.
