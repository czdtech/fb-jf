...
title: '[FR] Zombie Gun'
description: >-
  [FR] Zombie Gun is a physics shooter — ricochet bullets, trigger barrels, and
...
1.  **[FR]** Bank shots: Use walls to hit tucked targets.
2.  **[FR]** Red barrels: Chain explosions to clear clusters.
3.  **[FR]** Prop falls: Shoot supports to drop objects on enemies.
4.  **[FR]** Ammo discipline: Plan routes before firing.
5.  **[FR]** Armor rule: Use environment against armored zombies.
