...
title: '[DE] Fairyland'
description: >-
  [DE] Fairyland is a gentle puzzle adventure — explore cozy scenes, solve light
...
1.  **[DE]** Sweep methodically: Clear one scene at a time; zoom or pan for small interactables.
2.  **[DE]** Clue notebooks: Note symbol sequences and color orders for later doors.
3.  **[DE]** Optional tasks: Complete side objectives to unlock cosmetic rewards/hints.
4.  **[DE]** Route planning: If a scene has backtracking, collect items along a loop to minimize travel.
5.  **[DE]** Mini‑game focus: Read rules carefully — many allow quick retries without penalty.
