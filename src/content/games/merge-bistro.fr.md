...
locale: fr
urlstr: merge-bistro
title: '[FR] Merge Bistro'
description: >-
  [FR] Merge Bistro is a cozy merge‑management — combine ingredients, fulfill
...
1.  **[FR]** Queue reading: Prep items for upcoming orders to avoid idle waits.
2.  **[FR]** Board economy: Keep a lane for bases and a lane for high tiers; avoid clogging.
3.  **[FR]** Merge discipline: Only merge when you can immediately use or free space.
4.  **[FR]** Generators: Upgrade generators that feed the most common recipes first.
5.  **[FR]** Delivery timing: Turn in batches to trigger combo rewards.
