...
2.  Short hops: Prefer small taps for precision over full presses that overshoot.
3.  Buffer inputs: If supported, press slightly early to catch platform windows.
