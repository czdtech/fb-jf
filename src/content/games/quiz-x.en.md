...
2.  Category scan: Identify topic fast to recall relevant facts.
3.  Streak management: Answer confidently to keep multipliers; skip if unsure (if allowed).
4.  Time buffer: Don’t spend the entire timer on one tough question.
5.  Image prompts: Focus on distinctive features (flags, landmarks, animals).
