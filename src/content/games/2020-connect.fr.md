...
- **Relier les tuiles :** trace une ligne entre plusieurs cases portant le même nombre pour les fusionner en une seule case de valeur supérieure.
...
2. **Évite les coins :** les coins piègent souvent des nombres difficiles à fusionner. Utilise‑les plutôt pour les petites valeurs.
3. **Prévois les cascades :** organise des paires et trios de nombres identiques de manière à ce qu’une seule ligne tracée crée plusieurs fusions successives.
