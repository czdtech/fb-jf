...
title: '[ES] Football Penalty'
description: >-
  [ES] Football Penalty captures shootouts — place shots, vary height and
...
1.  **[ES]** Corners: Aim low corners for harder saves; high corners are strong but risk the bar.
2.  **[ES]** Disguise: Vary run‑up angles and shoot late to avoid telegraphing.
3.  **[ES]** Power: Medium‑high power keeps shots quick without ballooning.
4.  **[ES]** Keeper mode: Move late and dive toward foot/open‑body side.
5.  **[ES]** Mind wind (if modeled): Offset slightly and reduce height.
