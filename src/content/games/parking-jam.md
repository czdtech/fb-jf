...
2.  Minimal moves: Prefer moves that unlock multiple vehicles rather than local shuffles.
3.  Buffer lanes: Open a buffer lane early to allow deeper rearrangements.
