...
title: '[DE] Brain Test 3: Tricky Quests'
description: >-
  [DE] Here's your chance to play Brain Test 3: Tricky Quests Game. Have fun
  with this one!
...
*   **[DE]** **Fusion of Adventure and Puzzles:** The game is no longer a linear sequence of levels. Players must explore different scenes, find items, and use them to solve puzzles that block their path.
*   **[DE]** **Inventory System:** This is the biggest new feature. Players can collect various items found in the environment and store them in Alyx's backpack. You need to figure out how to combine these items or apply them to specific scenarios at the right moment.
*   **[DE]** **Workshop System:** Alyx has a workshop where you can combine key quest items or upgrade your tools, preparing you for the adventures ahead.
*   **[DE]** **Interactive Dialogue:** The game introduces a dialogue choice system. By talking to NPCs (Non-Player Characters), you can obtain clues and advance the plot. Different choices can lead to different (and often humorous) outcomes.
*   **[DE]** **Classic Tricky Puzzles:** Despite the new systems, the heart of the game remains the same: tricky puzzles that require you to use your imagination and challenge conventional thinking. Classic interactions like dragging, shaking, and zooming are still key to finding solutions.
...
*   **[DE]** **Core Principle: Explore and Collect**
    *   **[DE]** When entering a new area, don't rush to solve the immediate puzzle. First, carefully observe and tap on all suspicious objects to see what can be collected into your inventory.
*   **[DE]** **Master Your Inventory:**
    *   **[DE]** **Drag and Use:** When facing a challenge, open your backpack and try dragging items from it onto characters or objects in the scene.
    *   **[DE]** **Combine Items:** Sometimes, you need to drag two items onto each other within the inventory to craft a new, more useful tool.
    *   **[DE]** **Check All Items:** Don't forget what you're carrying. The key to the current puzzle might be an inconspicuous item you collected a long time ago.
*   **[DE]** **Pay Attention to Clues in Dialogue:**
    *   **[DE]** Read all conversations carefully. NPCs' words often directly or indirectly hint at what you need to do next or what item you should be looking for.
*   **[DE]** **Checklist for When You're Stuck:**
    1.   **[DE]** Have I interacted with every element in the scene? (Tapping, dragging, rubbing, etc.)
    2.   **[DE]** Is there an item in my backpack that I can use here?
    3.   **[DE]** Can I combine items in my backpack to create a new tool?
    4.   **[DE]** Do I need to return to a previous scene to find a missed item?
    5.   **[DE]** Did I miss any key information in the dialogue?
*   **[DE]** **The Hint System is Still Your Friend:**
    *   **[DE]** If all else fails, the built-in "light bulb" hint system is still available. It will point you toward the critical step or the required item, helping you overcome the obstacle.
