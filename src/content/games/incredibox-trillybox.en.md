...
1.  **Understand the Trap Music Sound Palette**:
    *   **Beats**: This is the backbone of any trap track. Expect to find iconic **808 kick drums**, deep sub-bass, sharp **snares or claps**, and the genre's signature fast, stuttering **hi-hats**.
    *   **Effects**: This category adds the atmospheric and rhythmic flair. It often includes sound effects, producer tags, or short vocal ad-libs ("yeah," "skrrt") that punctuate the beat.
    *   **Melodies**: Trap melodies are often simple, dark, and repetitive. Look for sounds like ominous **bell loops**, simple piano phrases, or dark, atmospheric synth lines.
    *   **Voices**: Vocals are central to trap. This category features **autotuned singing**, rhythmic rapping with a "triplet flow," and catchy vocal hooks.

2.  **The Beat is King**: Start your composition with the drums. A combination of a heavy 808 kick, a snare on the off-beat, and a fast hi-hat pattern is the quintessential trap foundation.

3.  **808s are Bass and Drums**: Remember that in trap music, the 808 often serves as both the kick drum and the bassline. Find the icon that provides that deep, booming bass and build around it.

4.  **Layer Simple Melodies**: Don't overcrowd the mix with complex melodies. Trap music thrives on simple, catchy, and often dark melodic loops. Find one or two that you like and let them repeat.

5.  **Systematic Bonus Hunting**: To find the three secret bonuses, be methodical. Establish a solid beat and bassline, then systematically swap out the melody and voice icons one by one until you trigger one of the animations.
