...
1.  ROI triage: Prioritize kitchens/baths, flooring, and paint; defer low‑impact rooms.
2.  Layout fixes: Remove bottlenecks, add storage, and ensure good flow.
3.  Theming: Keep a cohesive palette; mismatched rooms reduce appeal.
4.  Staging: Add a few decor items to lift perceived value.
5.  Budget control: Leave a contingency; don’t over‑invest beyond neighborhood caps.
