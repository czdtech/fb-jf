...
2.  **Look for Uncommon Letters:** If a word has an uncommon letter like J, Q, X, or Z, scan the entire grid for that letter first. Since it appears less frequently, it will significantly narrow down the possible locations for that word.
