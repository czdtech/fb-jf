...
title: '[FR] Basket Battle'
description: >-
  [FR] Basket Battle is a physics basketball duel — aim arcs, box out, and
...
1.  **[FR]** Arc aiming: Higher arcs drop softer and score more consistently.
2.  **[FR]** Rebounds: Box out after shots to secure second‑chance points.
3.  **[FR]** Tempo: Shoot quickly off rebounds before defense resets.
4.  **[FR]** Shot selection: Avoid flat drives from deep; step in for better odds.
5.  **[FR]** Mind wind (if any): Offset aim when wind appears.
