...
title: '[KO] Liquid puzzle sort colors'
description: >-
  [KO] Liquid puzzle sort colors is a relaxing pour‑sort — decant liquids by
...
1.  **[KO]** Keep two buffers empty if possible; they’re your escape valves.
2.  **[KO]** Build from completed bottles outward; lock finished colors early.
3.  **[KO]** Top‑down pours: Move top colors to consolidate stacks before addressing deep layers.
4.  **[KO]** Avoid burying singletons; surface odd colors early to prevent traps.
5.  **[KO]** Deadlock check: If all moves reverse progress, undo and change the pour order.
