...
2.  **Faire un coup :** Regarde la carte face visible de la défausse. Tu peux cliquer sur n'importe quelle carte face visible du tableau qui est d'un rang directement supérieur ou inférieur. Par exemple, si la carte de défausse est un 7, tu peux jouer un 6 ou un 8 du tableau. La couleur n'a pas d'importance.
3.  **As et Rois :** Les rangs sont cycliques. Cela signifie que tu peux placer un Roi sur un As, et un As sur un Roi, ce qui est crucial pour prolonger tes séries.
4.  **Découvrir des cartes :** Quand tu retires une carte du tableau, les cartes face cachée en dessous sont retournées et deviennent jouables.
