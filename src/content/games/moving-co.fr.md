...
title: '[FR] Moving Co'
description: >-
  [FR] Moving Co. turns moving day into a puzzle — plan routes, carry items
...
1.  **[FR]** Survey first: Identify large items and narrow passages; move big pieces before clutter blocks routes.
2.  **[FR]** Stack smart: Place heavy items first to stabilize loads; avoid stacking fragile pieces underneath.
3.  **[FR]** Shortest loops: Plan compact loops that grab multiple items per trip when possible.
4.  **[FR]** Turn radius: Rotate early through doors; wide turns reduce bumps and time losses.
5.  **[FR]** Handle fragile: Slow down near obstacles; a clean run beats a risky crash‑and‑restart.
