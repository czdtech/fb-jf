...
locale: zh
urlstr: checkers
title: '[ZH TRANSLATION NEEDED] Checkers'
description: >-
  [ZH TRANSLATION NEEDED] Learn the rules and strategies of Checkers, the
...
[ZH TRANSLATION NEEDED] In a digital version of Checkers, the controls are typically very simple point-and-click or tap-and-drag.
...
[ZH TRANSLATION NEEDED] **1. Is capturing an opponent's piece optional?**
[ZH TRANSLATION NEEDED] > No. In standard American Checkers rules, if a capture is available, you **must** make that move. This is known as a "forced capture" and is a fundamental part of the game's strategy.

[ZH TRANSLATION NEEDED] **2. What happens if I have multiple capture options?**
[ZH TRANSLATION NEEDED] > If you have a choice between different captures (e.g., two different pieces can each make a single jump), you can choose which one to make. If one piece has the option of a multi-jump sequence, you must take that sequence.

[ZH TRANSLATION NEEDED] **3. Can a regular piece (a "man") move backwards?**
[ZH TRANSLATION NEEDED] > No, standard pieces can only move diagonally *forward* towards the opponent's side of the board. Only a King can move both forwards and backwards.

[ZH TRANSLATION NEEDED] **4. How does a piece become a King?**
[ZH TRANSLATION NEEDED] > A piece becomes a King when it reaches the last row on the opponent's side of the board (the row where their pieces started). In a physical game, this is usually marked by placing a second checker of the same color on top of it.
