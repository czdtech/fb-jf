...
title: '[DE] Color Roll 3D'
description: >-
  [DE] Color Roll 3D is a satisfying unfold‑and‑fill puzzle — unroll strips in
...
1.  **[DE]** Start with the deepest/base color that covers the largest area.
2.  **[DE]** Place boundary strips to frame shapes, then fill interiors.
3.  **[DE]** Watch overlaps — avoid burying needed edges under later strips.
4.  **[DE]** Undo early when the final gaps look impossible.
5.  **[DE]** Compare with the target preview after each placement.
