...
2.  Timing window: Swing slightly late for leg‑side, earlier for off‑side drives.
3.  Target focus: Track required run rate; rotate strike when boundaries dry up.
