...
title: '[FR] Coloring Match'
description: >-
  [FR] Coloring Match teaches color mixing — blend paints to match targets,
...
1.  **[FR]** Match hue first (color wheel), then adjust saturation and value.
2.  **[FR]** Make small changes near the target; big swings overshoot.
3.  **[FR]** Compare under the same lighting/background if the UI offers it.
4.  **[FR]** Use undo/reset when the mix gets muddy.
5.  **[FR]** Learn complementary pairs to neutralize tints.
