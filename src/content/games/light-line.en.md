...
2.  Degree logic: Prioritize nodes with few exits; resolve them to reduce branching.
3.  Turn economy: Use long straight runs and save turns for corners that require them.
4.  Gate timing: Plan switch routes so gates open before line arrival.
5.  Backtrack early: Undo as soon as crossings become inevitable.
