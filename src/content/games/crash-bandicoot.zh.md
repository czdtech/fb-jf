...
在浏览器中体验一组精心挑选的关卡主题。玩家将操控古惑狼在关卡中一路前进，打碎木箱、
...
- 拆箱子获取道具或道路，但务必躲开 TNT 与带有爆炸标记的箱子。  
...
### 操作
<!-- i18n:controls:keys -->
- 按键（对齐）： `Arrow Keys` `Space`

- 方向键：移动 / 跳跃（上键）/ 下蹲（下键）  
- 空格键：旋转攻击（具体按键可能因托管平台略有差异）  

### 玩法技巧与策略

- 在移动平台或间距较大的坑前，先观察平台运动节奏，再选择合适的起跳时机。  
- 旋转攻击拆箱时尽量保持一点距离，尤其是 TNT 被触发后不要停留在炸药附近。  
- 尽可能多收集沃帕果，在部分版本中可以累计到一定数量获得额外生命。  
