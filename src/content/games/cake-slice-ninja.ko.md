...
seoTitle: Cake Slice Ninja 케이크 슬라이스 닌자 무료 온라인 플레이 | FiddleBops
description: >-
  Cake Slice Ninja는 날아오르는 케이크를 한 번에 썰어 내는 슬라이스 액션 게임입니다. 부드러운 스와이프로 여러 조각을 한꺼번에
  베어 콤보를 쌓고, 폭탄 같은 위험 요소는 피하며 하이스코어에 도전해 보세요.
