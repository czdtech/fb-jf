...
title: '[FR] Categories'
description: >-
  [FR] Categories is a quick word‑sorting brainteaser — group items by theme,
...
1.  **[FR]** Easy sets first: Lock obvious groups to shrink the search space.
2.  **[FR]** Test swaps: Move borderline items between plausible groups.
3.  **[FR]** Spot decoys: Items that seem to fit many groups are often misleads.
4.  **[FR]** Manage time: Don’t tunnel—cycle candidates quickly.
5.  **[FR]** Confirm with opposites: If two categories are close, define them by what they exclude.
