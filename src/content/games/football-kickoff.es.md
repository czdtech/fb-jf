...
title: '[ES] Football Kickoff'
description: >-
  [ES] Football Kickoff spotlights special teams — aim kicks, read wind, and
...
1.  **[ES]** Wind read: Offset aim into the wind; stronger winds require larger compensation.
2.  **[ES]** Power timing: Stop near the sweet spot; over‑powering increases hook/slice risk.
3.  **[ES]** Trajectory: For long kicks, add arc; for short accuracy, lower arc reduces drift.
4.  **[ES]** Kickoff placement: Target corners to limit returns; vary depth to force poor field position.
5.  **[ES]** Punts: Aim for coffin corner and hang time to allow coverage.
