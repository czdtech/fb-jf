...
도망자들의 “영혼 계약서(soul contracts 표기)”를 회수하라는 임무를 맡으면서 시작됩니다.
...
2. **패리 슬랩(Parry Slap 표기)을 반드시 익힐 것**  
...
3. **무기와 슈퍼를 상황에 맞게 활용하기**  
    ...
    - **슈퍼 아트(Super Arts 표기)**: 무덤(Mausoleum) 스테이지를 클리어하면 해금되는
...
(Porkrind's Emporium 표기)에서 무기와 참을 구매해야 보스전을 수월하게 진행할 수
있습니다.  
