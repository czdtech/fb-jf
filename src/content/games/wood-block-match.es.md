...
title: '[ES] Wood Block Match'
description: >-
  [ES] Wood Block Match is a calming block‑fit — place wooden shapes, clear
...
1.  **[ES]** Center breathing room: Keep the board center open; tidy edges to prevent single‑cell traps.
2.  **[ES]** Pocket planning: Reserve a 2×2 or L‑shaped pocket for awkward triominoes.
3.  **[ES]** Hard piece first: When crowded, place the largest/most awkward piece first.
4.  **[ES]** Double clears: Build two‑line setups so one piece clears both.
5.  **[ES]** Undo discipline: If available, undo immediately after a placement that seals pockets.
