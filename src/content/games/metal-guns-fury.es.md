...
title: '[ES] Metal Guns Fury'
description: >-
  [ES] Metal Guns Fury is a run‑and‑gun arcade — dodge bullets, manage weapons,
...
1.  **[ES]** Target priority: Turrets and rockets first; basic grunts later.
2.  **[ES]** Movement layering: Jump over low fire, slide under high arcs, then counter.
3.  **[ES]** Ammo economy: Burst fire, conserve rockets for multi‑targets/boss armor.
4.  **[ES]** Power‑ups: Route rescues to refresh HP/ammo before boss gates.
5.  **[ES]** Boss patterns: Read phases; punish windows rather than face‑tank.
