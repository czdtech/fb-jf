...
title: '[FR] Neon Rider'
description: >-
  [FR] Neon Rider delivers sleek bike‑physics runs — balance, throttle, and flip
...
1.  **[FR]** Land flat: Aim to touch down with wheels level to retain speed.
2.  **[FR]** Tap throttle: Feather power on bumpy terrain to avoid nose dives.
3.  **[FR]** Early corrections: Start pitch corrections in the air, not on landing.
4.  **[FR]** Small flips only: Flip when safe and with enough arc; unnecessary flips bleed speed.
5.  **[FR]** Learn lines: Memorize jump lengths and landing spots for perfect flow.
