...
locale: de
urlstr: speed-master
title: '[DE] Speed Master'
description: >-
  [DE] Speed Master is a precision reaction gauntlet — hit prompts on beat,
...
1.  **[DE]** Beat counting: Lock to a steady internal count; tap to beat rather than pure sight.
2.  **[DE]** Peripheral prediction: Track the next prompt while executing the current one.
3.  **[DE]** Late‑bias safety: Slightly late taps are safer than early (most engines accept late end‑frames).
4.  **[DE]** Two‑lane focus: Keep eyes between lanes; don’t hard‑fixate on one side.
5.  **[DE]** Regain cadence: After a miss, breathe, realign posture, then continue.
