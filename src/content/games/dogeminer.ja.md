...
locale: ja
urlstr: dogeminer
title: '[JA TRANSLATION NEEDED] DogeMiner'
description: >-
  [JA TRANSLATION NEEDED] DogeMiner is an idle clicker: mine coins, buy upgrades
...
### Overview
[JA TRANSLATION NEEDED] DogeMiner is an incremental idle/clicker game themed around mining coins. Click to mine manually, buy pickaxe upgrades and helpers (such as Shibes, statistics‑boosting tools, and factories), and automate production to earn faster. Later goals include traveling to the Moon and beyond with rocket upgrades. 
...
[JA TRANSLATION NEEDED]   A: Some hosts save progress locally and generate coins while the tab is open; full offline progress varies by host.   
- Q: What’s the long‑term goal?  
[JA TRANSLATION NEEDED]   A: Build enough production to launch rockets to the Moon and progress to later areas. 
