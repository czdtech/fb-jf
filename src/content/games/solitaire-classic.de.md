...
title: '[DE] Solitaire Classic'
description: >-
  [DE] The timeless single-player card game, also known as Klondike. Move all
...
2.  **[DE]** **Core Rules & Strategy:**
    ...
    *   **[DE]** **Building on the Tableau:** You can move cards between columns in the tableau. Cards must be placed on a card of the next-highest rank and of the opposite color (e.g., a black 7 on a red 8).
