...
1.  **Spielelemente verstehen:**
    *   **Tableau:** Der Hauptspielbereich mit sieben Spalten. Die erste Spalte hat eine Karte, die zweite zwei, und so weiter bis zur siebten Spalte. Nur die oberste Karte jeder Spalte liegt offen.
    *   **Ablagestapel (Foundations):** Oben rechts befinden sich vier leere Stapel, auf denen du die Karten jeder Farbe beginnend mit dem Ass in aufsteigender Reihenfolge ablegst.
    *   **Nachziehstapel (Stock):** Der restliche Kartenstapel, der verdeckt bereitliegt.
    *   **Ablagestapel (Waste):** Karten, die du vom Nachziehstapel aufdeckst, landen offen hier.

2.  **Grundregeln & Strategie:**
    *   **Verdeckte Karten aufdecken:** Versuche zuerst Züge, die verdeckte Karten im Tableau freilegen. Je mehr offene Karten du hast, desto mehr Optionen bekommst du.
    *   **Auf dem Tableau bauen:** Du darfst Karten zwischen den Spalten verschieben. Lege Karten immer auf eine Karte mit genau einem Rang höher und entgegengesetzter Farbe (z. B. eine schwarze 7 auf eine rote 8).
    *   **Auf die Ablagen legen:** Sobald ein Ass verfügbar ist, lege es auf einen Ablagestapel. Danach baust du in derselben Farbe in aufsteigender Reihenfolge weiter (Ass, 2, 3, 4 ...). Lege Karten auf die Ablagen, wenn es deine Tableau-Züge nicht blockiert.
