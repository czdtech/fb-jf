...
locale: de
urlstr: thief-puzzle
title: '[DE] Thief Puzzle'
description: >-
  [DE] Thief Puzzle is a mischievous rope‑arm puzzler — stretch, avoid traps,
...
1.  **[DE]** Probe path: Move slowly to test trigger ranges.
2.  **[DE]** Time windows: Pass lasers/guards right after cycle flips.
3.  **[DE]** Angle tricks: Wrap around corners to stay outside detection cones.
4.  **[DE]** Risk control: Abandon greedy arcs when cycles desync.
5.  **[DE]** Multi‑grab: Chain safe pickups before retracting.
