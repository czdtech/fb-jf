...
Chaque tour dispose de styles d’attaque, d’améliorations et de rôles différents. En éclatant des Bloons tu gagnes de l’argent, que tu investis dans de nouvelles tours ou des upgrades plus puissantes. Les manches deviennent progressivement plus difficiles avec des Bloons plus rapides, blindés ou invisibles.

Traits communs de la série :

-   **Bloons très variés :** après les Bloons rouges de base viennent des versions multicouches (bleues, vertes, jaunes…), mais aussi des Bloons **Camo** (invisibles), **Lead** (immunisés aux projectiles tranchants), **Regrow** (régénération rapide) ou **Fortified** (points de vie doublés).  
-   **Dirigeables géants :** les plus grandes menaces sont les blimps de classe MOAB (MOAB, BFB, ZOMG, DDT, BAD) qui encaissent des tonnes de dégâts et libèrent d’autres Bloons en explosant.  
-   **Système d’amélioration profond :** la plupart des tours possèdent trois chemins de progression, mais tu ne peux en renforcer que deux par tour, ce qui crée de nombreuses spécialisations.  
-   **Héros :** des unités spéciales très puissantes qui montent automatiquement en niveau pendant la partie et débloquent des compétences déterminantes.  
...
-   **Bâtis une défense équilibrée :**
    -   **Détection Camo :** Ninja Monkey, Sniper avec upgrade ou Monkey Village (Radar Scanner).
    -   **Cassure de Lead :** Bomb Shooter, Mortar Monkey ou tout projectile en feu/magique.
    -   **Contrôle des foules :** Tack Shooter, Bomb Shooter, Wizard Monkey pour effacer de gros paquets.
    -   **Dégâts MOAB :** Super Monkey, Spike Factory et autres upgrades haut niveau pour les blimps.
-   **Cherche les synergies :** Monkey Village et Alchemist servent à buffer tes unités principales ; combinés intelligemment, ils démultiplient ton DPS.  
...
-   **Placer une tour :** sélectionne-la dans l’interface (à droite / en bas), puis clique sur une zone valide de la carte.  
-   **Améliorer une tour :** clique sur une tour déjà placée pour ouvrir son menu d’upgrade et achète l’amélioration désirée si tu as assez d’argent.  
...
> - **BFB** (rouge) : contient 4 MOAB.  
> - **ZOMG** (noir) : contient 4 BFB.  
