...
1.  Corners first: Corner discs can never be flipped; securing corners often decides the game.
2.  Avoid “X‑squares” early: The diagonally adjacent squares to corners (X‑squares) often give your opponent an easy corner capture.
3.  Edge stability: Edges are powerful once stabilized; build safely from corners before expanding along the edge.
4.  Mobility over material (early): Keep your options open and deny moves to your opponent; too many early flips can backfire.
5.  Parity (endgame): Aim to move last in the final regions; controlling whether a region has odd/even empties can secure the final swing.
