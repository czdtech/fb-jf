...
2.  **Making a Move:** Look at the face-up card on the waste pile. You can click on any face-up card from the tableau that is one rank directly above or below it. For example, if the waste card is a 7, you can play either a 6 or an 8 from the tableau onto it. Suit does not matter.
3.  **Aces and Kings:** The ranks are wrapping. This means you can place a King on an Ace, and an Ace on a King, which is crucial for extending your runs.
4.  **Uncovering Cards:** When you remove a card from the tableau, any face-down cards beneath it are turned over, making them available for play.
