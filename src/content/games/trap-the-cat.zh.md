...
locale: zh
urlstr: trap-the-cat
title: '[ZH TRANSLATION NEEDED] Trap the Cat'
description: >-
  [ZH TRANSLATION NEEDED] Trap the Cat is a strategic puzzle game where players
  must block a clever cat's escape routes by placing barriers on a hexagonal
  grid, using logic and planning to prevent the cat from reaching the edge.
...
[ZH TRANSLATION NEEDED] "Trap the Cat" is a strategic puzzle game where players must block a clever cat's escape routes by placing barriers on a hexagonal grid, using logic and planning to prevent the cat from reaching the edge. This game tests players' prediction abilities and strategic thinking.
