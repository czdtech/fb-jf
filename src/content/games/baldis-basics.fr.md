...
title: '[FR] Baldi''s Basics'
description: >-
  [FR] A detailed guide to Baldi's Basics, the parody survival horror game.
...
1.  **[FR]** **Sound is Your Most Important Tool:** Baldi's primary method of locating you is sound. He is drawn to the sound of opening and closing doors. More importantly, you can track his proximity by listening to the sound of his ruler slapping against his hand. The louder and more frequent the slap, the closer he is. Use this to your advantage to know when to hide or run.
2.  **[FR]** **Stamina Management is Key:** You have a limited stamina bar for running (activated with the Shift key). Do not waste it. Only run when Baldi is very close or when you need to quickly cross an open area. The Principal will also put you in detention for running in the halls, so be mindful of his location.
3.  **[FR]** **Learn the Characters and How to Counter Them:**
    *   **[FR]** **Baldi:** He gets faster with every notebook you collect. Keep your distance and use sound to misdirect him if possible.
    *   **[FR]** **Playtime:** A little girl with a jump rope who will force you to play with her, stopping you in your tracks. The only way to escape quickly is by using the **Safety Scissors** to cut her rope. Always try to have scissors on hand.
    *   **[FR]** **Principal of the Thing:** He roams the halls and will send you to detention (a 15-30 second timeout) for breaking school rules (running, entering faculty rooms, using BSoda in the halls). Avoid him when you need to run.
    *   **[FR]** **It's a Bully:** Blocks hallways and demands an item. You must give him something from your inventory to pass. It's often best to find an alternate route.
    *   **[FR]** **Gotta Sweep:** A giant broom that periodically sweeps through the halls, pushing all characters (including you and Baldi) in its path. It can be a lifesaver or a death sentence depending on the situation.
    *   **[FR]** **1st Prize:** A slow-moving robot that will hug you and push you down a hallway. He can be annoying, but sometimes he can push you away from Baldi. You can use the scissors on his wiring to disable him temporarily.
4.  **[FR]** **Item Strategy:**
    *   **[FR]** **BSoda:** A can of soda that can be used to push characters away. Excellent for creating distance from Baldi or getting past the Bully without losing a more valuable item.
    *   **[FR]** **Energy Flavored Zesty Bar:** Fully restores your stamina. Invaluable for making a long run.
    *   **[FR]** **Safety Scissors:** Your counter to Playtime and 1st Prize. A top-priority item.
    *   **[FR]** **Quarter:** Can be used in vending machines to get a BSoda or on the payphone in the Principal's office to briefly distract Baldi.
5.  **[FR]** **The Final Escape:** After collecting all seven notebooks, the school will turn red, an alarm will blare, and Baldi will move at his maximum speed. You must find three exits, which will initially be blocked. After touching all three fake exits, the fourth and final exit will open, allowing you to escape. This final phase is a pure test of speed, item usage, and luck.

### Controls Guide

Controls are standard for first-person PC games.

*   **[FR]** **`W`, `A`, `S`, `D` Keys**: Move forward, left, backward, and right.
*   **[FR]** **Mouse**: Look around.
*   **[FR]** **`Left-Shift` Key**: Hold to run (consumes stamina).
*   **[FR]** **`Left Mouse Button`**: Open doors and pick up items.
*   **[FR]** **`Right Mouse Button`**: Use the currently selected item.
*   **[FR]** **Mouse Scroll Wheel**: Cycle through your inventory items.
*   **[FR]** **`Spacebar`**: Look behind you (in newer versions/updates).
...
The main rules are:
*   **[FR]** No Running (he will catch you if he sees you).
*   **[FR]** No Entering Faculty Rooms.
*   **[FR]** No Drinking (using BSoda in front of him).
*   **[FR]** No Bullying (this applies to the Bully character).
