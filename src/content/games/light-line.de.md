...
title: '[DE] Light Line'
description: >-
  [DE] Light Line is a luminous path‑drawing puzzler — connect nodes without
...
1.  **[DE]** Start with bottlenecks: Fill narrow corridors first; they force unique routes.
2.  **[DE]** Degree logic: Prioritize nodes with few exits; resolve them to reduce branching.
3.  **[DE]** Turn economy: Use long straight runs and save turns for corners that require them.
4.  **[DE]** Gate timing: Plan switch routes so gates open before line arrival.
5.  **[DE]** Backtrack early: Undo as soon as crossings become inevitable.
