...
title: '[FR] Minesweeper 1000'
description: >-
  [FR] Minesweeper 1000 refreshes classic minesweeper — read number logic, flag
...
1.  **[FR]** Core patterns: Master 1-2, 1-1, and 1-2-1 edge patterns to place flags deterministically.
2.  **[FR]** Chording: On many builds, clicking a number with all its mines flagged opens surrounding safe tiles; abuse this for speed.
3.  **[FR]** Probability: When forced to guess, choose corners with more unknown neighbors to maximize information.
4.  **[FR]** Frontier focus: Solve along the boundary between known and unknown; avoid random digs deep in fog.
5.  **[FR]** Flag hygiene: Only flag when certain; otherwise keep candidate notes (if the build supports marks).
