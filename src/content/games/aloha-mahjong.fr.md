...
title: '[FR] Aloha Mahjong'
description: >-
  [FR] Aloha Mahjong is a relaxing tile‑match — find pairs, clear layers, and
  enjoy island vibes.
...
1.  **[FR]** Open structures: Free tiles that unlock the most others.
2.  **[FR]** Pair priorities: Clear rare symbols early to prevent deadlocks.
3.  **[FR]** Look ahead: Avoid removing tiles that seal deeper pairs.
4.  **[FR]** Use shuffles sparingly when blocked.
5.  **[FR]** Time vs. accuracy: In timed modes, balance speed with safe picks.
