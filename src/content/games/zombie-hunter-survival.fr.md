...
title: '[FR] Zombie Hunter: Survival'
description: >-
  [FR] Zombie Hunter: Survival is a tense top‑down shooter — kite hordes,
...
1.  **[FR]** Circle kite: Run wide circles to group zombies and fire into clumps.
2.  **[FR]** Reload discipline: Reload between waves or during long kites—not face‑to‑face.
3.  **[FR]** Funnel use: Fight in chokepoints for cleaner head‑on shots.
4.  **[FR]** Target priority: Eliminate fast/ranged threats first.
5.  **[FR]** Resource grabs: Take ammo/health only when routes are clear.
