...
title: '[ES] Mazes'
description: >-
  [ES] Mazes delivers classic labyrinth runs — draw optimal paths, dodge traps,
...
1.  **[ES]** Right/left‑hand rules: Use wall‑following on simply connected mazes; abandon on multi‑loops.
2.  **[ES]** Shortcut scouting: Zoom to spot door/switch pairs and plan a single sweep.
3.  **[ES]** Trap memory: Mark dangerous tiles mentally to avoid repeat hits.
4.  **[ES]** Time splits: Don’t chase a perfect line first; secure a finish, then optimize.
5.  **[ES]** Safe corridors: Favor wide lanes when precision is shaky.
