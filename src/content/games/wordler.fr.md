...
title: '[FR] Wordler'
description: >-
  [FR] Wordler is a daily deduction word game — guess five‑letter words,
...
1.  **[FR]** Strong opener: Use a high‑coverage starter with common vowels/consonants (e.g., SLATE/CRANE/ROAST).
2.  **[FR]** Letter accounting: Track confirmed/excluded letters explicitly; avoid re‑testing dead letters.
3.  **[FR]** Position logic: Fix green letters, permute yellows across remaining slots.
4.  **[FR]** Frequency bias: Favor common digrams (TH, CH, SH, ST) and endings (‑ER, ‑ED, ‑ING).
5.  **[FR]** Endgame pruning: Before final guesses, shortlist all valid permutations to avoid whiffs.
