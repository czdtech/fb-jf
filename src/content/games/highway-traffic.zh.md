...
### **操作说明**
<!-- i18n:controls:keys -->
- 按键（对齐）： `A` `D` `Left/Right Arrow` `W` `Up Arrow` `S` `Down Arrow`
...
**4. 双向模式有什么特别之处？**  
双向车流模式难度更高，但奖励也更丰厚。你需要同时躲避同向与逆向的车辆，如果敢长时间在对向车道逆行，通常会获得双倍甚至更高的得分倍率。不过这也意味着操作空间被压缩，一旦判断失误，就有可能正面对撞导致这一局直接结束。
