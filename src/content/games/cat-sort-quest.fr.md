...
title: '[FR] Cat Sort Quest'
description: >-
  [FR] Cat Sort Quest is a cozy color‑sorting puzzler — move cats between
...
1.  **[FR]** Keep one buffer empty as long as possible to enable reshuffles.
2.  **[FR]** Finish colors early when it frees another perch (snowball effect).
3.  **[FR]** Surface singles: Don’t bury unique colors under mixed stacks.
4.  **[FR]** Two‑step preview: Simulate next moves to avoid creating softlocks.
5.  **[FR]** Merge partial stacks of the same color promptly to release space.
