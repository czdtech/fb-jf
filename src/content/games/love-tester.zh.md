...
locale: zh
urlstr: love-tester
title: '[ZH TRANSLATION NEEDED] Love Tester'
description: >-
  [ZH TRANSLATION NEEDED] Playful novelty: enter names to get a fun
...
### Overview
[ZH TRANSLATION NEEDED] Love Tester is a lighthearted name‑matching toy. You input two names and receive a whimsical “compatibility” percentage with occasional messages or animations. It’s purely for fun—results are random or based on simple hashing and do not represent real compatibility.
...
[ZH TRANSLATION NEEDED]   A: No, it is for entertainment only.
- Q: Can I save or share the results?  
[ZH TRANSLATION NEEDED]   A: Some hosts include share buttons or screenshots.
- Q: Do spaces or punctuation matter in names?  
[ZH TRANSLATION NEEDED]   A: Behavior varies; stick to letters for consistent outputs.
