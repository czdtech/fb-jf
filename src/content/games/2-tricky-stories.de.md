...
title: '[DE] Brain Test 2: Tricky Stories'
description: >-
  [DE] Here's your chance to play Brain Test 2: Tricky Stories Game. Have fun
  with this one!
...
*   **[DE]** **Story-Driven Levels:** The game is structured around various characters and their adventures, such as Agent Smith's mission, Emily's farm life, and Monster Hunter Joe's escapades. Each chapter tells a short story, and players advance the plot by solving puzzles.
*   **[DE]** **Diverse Puzzle Design:** The puzzles are incredibly varied, covering logic, observation, common sense (and sometimes, the opposite of common sense), and creativity.
*   **[DE]** **Highly Interactive Controls:** Players need to interact with game elements through a variety of actions, including tapping, dragging, merging, shaking the phone, tilting the device, and pinching to zoom. Sometimes, the solution is hidden within the level's title text or the UI itself.
*   **[DE]** **Humorous Art Style:** The game features a clean and vibrant cartoon art style. The characters and animations are full of humor, and even the failure animations are often amusing.
*   **[DE]** **Hint System:** If a player gets stuck on a level, they can use the in-game "light bulb" hints to get a clue or even skip the level entirely (usually by watching an ad).
...
*   **[DE]** **Think Outside the Box:** This is the most crucial principle. Do not apply everyday logic to the problems. The answer is often the option you initially dismissed.
*   **[DE]** **Interact with Everything on the Screen:**
    *   **[DE]** **Drag:** Try dragging every object, including background elements like clouds, the sun, or even the words in the question.
    *   **[DE]** **Combine:** Attempt to drag two or more items together to see if they can be combined into a new tool.
    *   **[DE]** **Tap/Rub:** Repeatedly tap or rub an object; it might trigger a hidden effect.
*   **[DE]** **Read the Question Carefully:** The text of the question itself is often a key clue. Pay attention to puns, keywords, or hidden instructions.
*   **[DE]** **Utilize Your Phone's Hardware Features:**
    *   **[DE]** **Shake:** Many levels require you to shake your phone to make objects fall or move.
    *   **[DE]** **Tilt:** Tilting your device can change the direction of gravity, affecting liquids or movable objects.
    *   **[DE]** **Volume Buttons:** A few puzzles might require you to interact with your phone's volume keys.
    *   **[DE]** **Rotate/Flip:** Turning your phone upside down or rotating it can also be a solution.
*   **[DE]** **Pay Attention to Details and Numbers:** Carefully observe all details in the scene. Count the number of objects and check if anything is hidden behind something else.
*   **[DE]** **Don't Be Afraid to Fail:** The game encourages trial and error. Trying different approaches is a necessary part of finding the correct solution.
*   **[DE]** **Use the Hint System Wisely:** If you are genuinely stuck for a long time, use a light bulb hint. It will give you a critical clue rather than the direct answer, helping to guide your thought process.
...
1.  **[DE]** As a reward for completing certain levels or chapters.
2.  **[DE]** Through daily login bonuses.
3.  **[DE]** By watching optional rewarded video ads.
4.  **[DE]** By purchasing them directly via in-app purchases.
