...
seoTitle: Jouez à Incredibox Shatter Sprunk en ligne gratuitement | FiddleBops
description: >-
  Incredibox Shatter Sprunk est un mod fan‑made au style Sprunki : personnages
  jaunes percutants, principe de glisser‑déposer classique et combos à découvrir
  pour déclencher des animations spéciales.
...
Incredibox Shatter Sprunk, un mod fan‑made, te plonge dans un monde musical qui combine le principe classique d'Incredibox avec le style décalé de Sprunki ! Ici, tu créeras tes propres œuvres musicales avec un groupe de personnages animés uniques.
 
<!-- i18n:section:how-to-play -->
### Comment jouer à Incredibox Shatter Sprunk ?
 
Le principe est très simple, tu peux te lancer en quelques étapes :
 ...
 - **Superpose ta composition :** Ajoute plusieurs personnages sur scène, combinant leurs sons pour construire une piste musicale en couches. Tu peux avoir plusieurs personnages actifs en même temps, selon le design du mod.
 - **Expérimente et ajuste :** Retire ou échange des sons en faisant glisser les icônes hors des personnages ou en les remplaçant par de nouvelles. Écoute comment les couches interagissent et ajuste‑les pour créer une composition cohérente.
 ...
 - **Sauvegarde et partage :** Une fois satisfait de ta création, utilise la fonction de sauvegarde ou de partage du jeu pour l’enregistrer ou la partager avec d'autres.
...
L'utilisation d'Incredibox Shatter Sprunk est très simple, tu peux tout faire facilement avec la souris :
 ...
 - **Ajuster le tempo :** Certains mods incluent un curseur ou des boutons de tempo — clique et fais glisser ou clique pour ajuster la vitesse de ta composition.
