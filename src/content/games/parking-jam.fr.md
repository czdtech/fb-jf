...
locale: fr
urlstr: parking-jam
title: '[FR] Parking Jam'
description: >-
  [FR] Parking Jam is a spatial slider — move cars in sequence, free the exit
...
1.  **[FR]** Goal backchain: Work backward from the exit to identify cars that truly gate progress.
2.  **[FR]** Minimal moves: Prefer moves that unlock multiple vehicles rather than local shuffles.
3.  **[FR]** Buffer lanes: Open a buffer lane early to allow deeper rearrangements.
4.  **[FR]** Priority stack: Park non‑critical cars in dead zones to keep corridors free.
5.  **[FR]** Undo early: If progress stalls, rewind before the last “dead shuffle” and choose a different unlock.
