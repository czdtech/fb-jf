...
locale: fr
urlstr: basket-champ
title: '[FR] Basket Champ'
description: >-
  [FR] Basket Champ is a one‑touch hoop challenge — set arc, swish clean, and
...
1.  **[FR]** Aim above rim center for soft drops.
2.  **[FR]** Time moving hoops—shoot at consistent cycle points.
3.  **[FR]** Recover after misses: reset rhythm before next attempt.
4.  **[FR]** Ignore risky coins when alignment is poor.
5.  **[FR]** Use practice to nail specific obstacle patterns.
