...
schickst einen Pinguin eine Rampe hinunter, steuerst seine Fluglage, um die
Gleitstrecke zu maximieren, und setzt Booster mit Bedacht ein. Mit dem
verdienten Geld kaufst du bessere Flügel, Raketen und Zusatzteile, schaltest
...
- **Startwinkel wählen:** Stelle vor dem Start den Absprungwinkel ein und halte
  während des Flugs eine möglichst optimale Fluglage, um Geschwindigkeit zu
  behalten.
- **Booster sinnvoll einsetzen:** Zünde deine Raketen nur, wenn du deutlich an
  Tempo verlierst oder Hindernisse überfliegen musst.
...
- Flache Sturzflüge holen dich wieder auf Tempo, sanfte Steigflüge verlängern
  die Distanz. Wechsle beides ab, um optimal zu gleiten.
- Heb dir einen Teil des Treibstoffs dafür auf, wenn der Pinguin merklich
  langsamer wird – so holst du das Maximum aus der Flugstrecke.
