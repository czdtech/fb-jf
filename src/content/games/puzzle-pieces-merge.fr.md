...
*   **Q : Comment les pièces fusionnent‑elles ?**
    *   **R :** Place simplement une pièce dans sa position correcte à côté d'une autre pièce avec laquelle elle se connecte. Si le placement est correct, elles s'emboîteront automatiquement et fusionneront.

*   **Q : Je ne trouve pas où va une pièce. Que dois‑je faire ?**
    *   **R :** D'abord, essaie de la faire pivoter. Si tu es toujours bloqué, mets‑la de côté et concentre‑toi sur une autre section du puzzle. Souvent, remplir les zones environnantes révélera exactement où la pièce difficile doit aller. Si tout le reste échoue, utilise un indice si disponible.
