...
locale: en
title: Gin Rummy
seoTitle: Play Gin Rummy Online Free | FiddleBops
description: >-
  Play the classic card game of Gin Rummy. Form your cards into sets and runs,
  knock to end the round, and try to catch your opponent with a hand full of
  deadwood.
...
2.  **Melds:**
    ...
    *   **Runs:** Three or more cards of the same suit in sequence (e.g., 5♣ 6♣ 7♣).
3.  **The Turn:** On your turn, you must perform two actions:
    *   **Draw:** Take either the top face-up card from the discard pile OR the top face-down card from the stock pile.
    *   **Discard:** Discard one card from your hand onto the discard pile, placing it face-up.
4.  **Knocking:** You can end the round by "knocking" if your deadwood value is 10 or less. To knock, you discard a card and then lay out your melds and deadwood. Your opponent then gets a chance to lay off their own deadwood cards on your melds.
