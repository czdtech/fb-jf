...
2.  Power timing: Stop near the sweet spot; over‑powering increases hook/slice risk.
3.  Trajectory: For long kicks, add arc; for short accuracy, lower arc reduces drift.
4.  Kickoff placement: Target corners to limit returns; vary depth to force poor field position.
5.  Punts: Aim for coffin corner and hang time to allow coverage.
