...
- 问：遇到很难的题目就会大脑一片空白，怎么办？
  ...
  答：先用排除法划掉明显不可能的选项，再从剩下的选出最靠谱的一个。如果游戏支持跳题功能，可以适当跳过，优先保护连击。

<!-- i18n:faq:id=faq:quiz-x:picture-questions-stump-me-a21adfaf -->
- 问：图片题总是做不好，有什么技巧？
  
  答：可以刻意记一些常见国旗、知名地标和典型动物的特征，例如颜色组合、图案位置或轮廓形状。答题时先抓住这些明显特征，再结合选项进行匹配。

<!-- i18n:faq:id=faq:quiz-x:multiplayer-fc9199ff -->
- 问：有多人或对战模式吗？
  
  答：部分版本提供实时对战或排位玩法；进入房间前建议先阅读房间规则与计分方式，确认特殊机制后再开始。
