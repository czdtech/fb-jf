...
title: '[DE] Kings and Queens'
description: >-
  [DE] Kings and Queens is a regal match‑3 adventure — clear obstacles, unlock
...
1.  **[DE]** Board control: Clear central blockers first to open space for combos.
2.  **[DE]** Booster timing: Save hammers/rockets for late‑board choke points.
3.  **[DE]** Combo planning: Merge power‑ups (bomb+line/color clears) right before tight goals.
4.  **[DE]** Star economy: Spend on boosters that directly help your current hurdle.
5.  **[DE]** Move math: Count remaining blockers vs moves and play for the objective, not points.
