...
2.  **Shuffle the Letters:** If you get stuck and can't see any more words, use the "Shuffle" button. Rearranging the letters in the circle can often spark new ideas and help you see combinations you missed before.
3.  **Use Hints Sparingly:** The "Hint" button will reveal a random letter in the puzzle for you, which can be a great help. However, you usually have a limited number of hints, so save them for when you are truly stuck.
4.  **Find Bonus Words:** Don't stop once the crossword is full! Most levels have extra "Bonus Words." These are valid words made from the letters that don't fit into the main puzzle. Finding them will award you extra coins or points.
