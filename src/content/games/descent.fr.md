...
une tour de plateformes. Tu dois trouver des passages pour continuer à descendre
sans te retrouver coincé ni écrasé par l’écran qui défile.
...
1.  **Anticipe les ouvertures**  
    Regarde toujours les plateformes situées quelques étages en dessous pour
    choisir ton prochain point de chute.
2.  **Évite de rester au sommet de l’écran**  
    Si tu traînes trop, l’écran te rattrapera et tu perdras.
3.  **Profite des plateformes mobiles**  
    Certaines se déplacent latéralement : utilise‑les pour te placer au‑dessus
    d’une bonne ouverture.
