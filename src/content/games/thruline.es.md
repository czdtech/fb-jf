...
title: '[ES] Thruline'
description: >-
  [ES] Thruline is a clean connect‑the‑network — draw a single continuous line
...
1.  **[ES]** Bottlenecks first: Claim narrow corridors before they close.
2.  **[ES]** Turn budgeting: Minimize turns on long runs; save them for tight corners.
3.  **[ES]** Bridge logic: Cross only on provided bridges; treat them as limited resources.
4.  **[ES]** Early backtrack: Undo as soon as isolation appears.
5.  **[ES]** Symmetry exploitation: Mirror partial solutions in symmetric layouts.
