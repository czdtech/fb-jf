...
locale: es
urlstr: slice-master
title: '[ES] Slice Master'
description: >-
  [ES] Slice Master is a satisfying physics-based game where players control a
...
1.  **[ES]** **Master Cutting Timing**: Learn to cut at the right moments to ensure maximum scoring and effectiveness.
2.  **[ES]** **Object Recognition**: Identify cuttable and non-cuttable objects, avoiding collision with obstacles.
3.  **[ES]** **Angle Control**: Adjust the knife's angle to achieve optimal cutting effects.
4.  **[ES]** **Combo System**: Build consecutive successful cuts to earn higher score bonuses.
5.  **[ES]** **Collect Items**: Gather special items and coins in levels to enhance abilities.

### How to Play

*   **[ES]** **Direction Control**: Typically use mouse or touch to control the knife's movement direction.
*   **[ES]** **Cutting Action**: Click or swipe to perform cutting actions.
*   **[ES]** **Angle Adjustment**: Drag to adjust the knife's angle and trajectory.

### Frequently Asked Questions

1.  **[ES]** **Q: How do I get perfect cuts?**
