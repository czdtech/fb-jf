...
1.  **探索:** すべてのパスを徹底的に検索します。
2.  **アイテムを収集:** ツールとリソースは重要です。
3.  **パズルを解決:** スイッチ、レバー、隠されたパスに注意してください。
4.  **障害物を避ける:** 溶岩、敵、落下に注意してください。
5.  **通った道を覚える:** 迷いやすい場所は、通過済みのルートを意識します。
