...
title: '[FR] Tiger Run'
description: >-
  [FR] Tiger Run is a jungle runner — dash, jump, and slide to dodge obstacles
  and collect coins.
...
1.  **[FR]** Eyes up: Look ahead to prepare lane swaps early.
2.  **[FR]** Priority safety: Skip side coins when gaps are tight.
3.  **[FR]** Memorize sets: Common obstacle patterns repeat—use them to pre‑position.
4.  **[FR]** Smooth inputs: Quick, small moves reduce overcorrection at high speed.
5.  **[FR]** Power‑ups: Save shields/magnets for dense sections.
