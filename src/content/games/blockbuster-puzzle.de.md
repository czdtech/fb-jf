...
Linien oder Blöcke zu löschen. Der Reiz liegt im Tempo und in der Planung:
Du möchtest mehrere "Spuren" offenhalten, Züge vorbereiten, die große Bereiche
...
1.  **Zwei Bahnen frei halten:** Versuche, immer mindestens zwei flexible
    Bereiche auf dem Feld zu behalten, in die du sperrige Formen noch
    hineinbekommst.
2.  **Rettungstasche reservieren:** Halte eine Ecke oder Tasche als Notausgang
    frei, um bei sehr schlechten Teilen nicht sofort zu verlieren.
3.  **In Clustern denken:** Lege verwandte Formen so, dass ein weiterer Zug
    mehrere Clears hintereinander auslösen kann.
4.  **Einzel‑Zellen vermeiden:** Kleine, isolierte Einzelfelder sind fast nie
    sinnvoll nutzbar und führen schnell zum Platzproblem.
5.  **Vorsprung in Raum umwandeln:** Wenn dein Board gerade sehr offen ist,
