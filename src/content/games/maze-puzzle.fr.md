...
locale: fr
urlstr: maze-puzzle
title: '[FR] Maze Puzzle'
description: >-
  [FR] Maze Puzzle is a clean labyrinth runner — plot shortest paths, bait
...
1.  **[FR]** Key ordering: Plan an order that minimizes backtracking.
2.  **[FR]** Landmarks: Use unique tiles to avoid loops.
3.  **[FR]** Patrol baiting: Step into edge of vision to lure guards, then slip past.
4.  **[FR]** Dead‑end pruning: Explore branches shallowly; abandon when they don’t progress keys.
5.  **[FR]** Timer awareness: Don’t rush — precision saves more time than speed blunders.
