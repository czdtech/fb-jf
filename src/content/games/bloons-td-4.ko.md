...
seoTitle: Bloons TD 4 블룬스 TD 4 무료 온라인 플레이 | FiddleBops
description: >-
...
-   **새로운 비행선 BFB**: 붉은색 **B.F.B. (Brutal Flying Behemoth, BFB의 약자)**가
...
-   **카모·리드 블룬은 반드시 대비하기**  
    -   **Camo Bloon(카모 블룬)**: 감지 가능한 타워가 아니면 공격 자체가
        ...
        Tower(`Signal Flare` 업그레이드) 등이 대표적인 해답입니다.
...
> BFB(Brutal Flying Behemoth, BFB의 약자)는 MOAB보다 훨씬 더 튼튼하고 체력이 높습니다.
