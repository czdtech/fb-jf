...
2.  **Capturer de nouveaux Pokémon :** rencontre des Pokémon sauvages dans les hautes herbes et autres zones, affaiblis‑les et utilise des Poké Balls pour les capturer, agrandissant ton équipe.
3.  **Entraîner et faire évoluer :** gagne de l'expérience à travers les combats pour monter de niveau tes Pokémon, et utilise des Pierres d'Évolution ou des conditions spécifiques pour les faire évoluer, améliorant leur force.
...
1.  **Q : Quels sont les Pokémon starters dans Pokemon Fire Red ?**
    **R :** Les Pokémon starters sont Bulbizarre (type Plante), Salamèche (type Feu) et Carapuce (type Eau).
2.  **Q : Comment échanger des Pokémon dans le jeu ?**
    **R :** L'échange nécessite de se connecter avec un autre joueur via la fonction de communication en jeu, généralement fait dans un Centre Pokémon.
3.  **Q : Quels Pokémon Légendaires peut‑on capturer dans le jeu ?**
