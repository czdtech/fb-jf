...
title: '[KO] Basketball serial shooter'
description: >-
  [KO] Basketball serial shooter turns rapid‑fire hoops into skill — set arcs,
...
1.  **[KO]** Build a repeatable form: Pick a comfortable cursor position and release rhythm so each attempt feels consistent.
2.  **[KO]** Arc over power: Favor higher arcs that drop softly; flat line‑drives rim out more often.
3.  **[KO]** Read cycles: For moving hoops, identify the motion cycle and shoot at the same phase each time.
4.  **[KO]** Work inside‑out: Take nearer, higher‑percentage shots to establish a streak before attempting long‑range baskets.
5.  **[KO]** Recover quickly: If you miss, pause half a beat to re‑center aim and re‑establish rhythm before the next shot.
6.  **[KO]** Wind adjustment (if present): Offset aim into the wind and add a touch more arc to compensate for drift.
7.  **[KO]** Goal management: In timed modes, ignore risky coins or side targets unless alignment is clean.
