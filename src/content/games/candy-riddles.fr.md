...
title: '[FR] Candy Riddles'
description: >-
  [FR] Candy Riddles is a cheerful match‑3 — swap sweets, trigger combos, and
...
1.  **[FR]** Work from the bottom to generate natural cascades that clear more tiles for free.
2.  **[FR]** Target objectives first (e.g., remove blockers, collect items) before chasing score.
3.  **[FR]** Combine power‑ups: merging a line‑clear with a bomb or color clear often wipes large areas.
4.  **[FR]** Avoid isolating colors near walls; keep the board open for future matches.
5.  **[FR]** On limited‑move stages, map two to three moves ahead to conserve steps.
