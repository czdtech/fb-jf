...
- **부족 리더가 되기:**
  여러 명의 비트박서/연주자 캐릭터를 이끌며, 강렬한 부족 리듬을 만들어 보세요.
- **원초적인 사운드 탐험:**
  딜러리두, 부족 북, 깊은 챈트 등 호주 원주민 음악에서 영감을 받은 사운드를
  활용해, 기존 스프룽키와는 전혀 다른 느낌의 곡을 만들 수 있습니다.
- **창의적인 작곡:**
  독특한 효과음과 타악 요소를 조합해, 매번 새로운 스타일의 곡을 시도해 보세요.

### Sprunki Retake Bonus Characters의 세계에서

- 각 캐릭터의 디자인과 사운드는 호주 어보리진 음악의 상징과 분위기를 담고 있어,
  마치 오래된 부족 마을 한가운데에서 연주하는 듯한 느낌을 줍니다.
- 조합 가능한 캐릭터와 사운드가 많아, 매번 다른 명곡을 만들 수 있습니다.
- 완성한 곡은 친구·가족과 공유하며, 문화와 음악이 섞이는 순간을 함께
  즐길 수 있습니다.
