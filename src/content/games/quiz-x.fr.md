...
title: '[FR] Quiz x'
description: >-
  [FR] Quiz x is a fast quiz show — read prompts, think broadly, and pick
...
1.  **[FR]** Eliminate: Remove obviously wrong options before committing.
2.  **[FR]** Category scan: Identify topic fast to recall relevant facts.
3.  **[FR]** Streak management: Answer confidently to keep multipliers; skip if unsure (if allowed).
4.  **[FR]** Time buffer: Don’t spend the entire timer on one tough question.
5.  **[FR]** Image prompts: Focus on distinctive features (flags, landmarks, animals).
