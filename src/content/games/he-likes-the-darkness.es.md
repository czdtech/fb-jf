...
title: '[ES] He Likes The Darkness'
description: >-
  [ES] He Likes The Darkness is a moody platformer — navigate shadowy stages,
...
1.  **[ES]** Light scouting: Use small hops to reveal platform edges without overcommitting.
2.  **[ES]** Cycle timing: Observe moving hazards (saws/spikes) for a full cycle, then commit.
3.  **[ES]** Momentum: Keep micro‑momentum through tap‑taps rather than full stops.
4.  **[ES]** Orb routing: Grab orbs on safe passes; don’t force risky backtracks.
5.  **[ES]** Retry rhythm: Fast restarts build muscle memory for tricky segments.
