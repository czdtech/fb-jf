...
title: '[FR] Tic Tac Toe Mania'
description: >-
  [FR] Tic Tac Toe Mania is a brisk duel — bait forks, block threats, and force
...
1.  **[FR]** Center first: On 3×3, center maximizes forks; corners second.
2.  **[FR]** Block immediately: Always respond to a two‑in‑a‑row.
3.  **[FR]** Create forks: Set up positions where two lines can win next.
4.  **[FR]** Anti‑fork: Play to break opponent fork patterns.
5.  **[FR]** Variants: On larger boards, prioritize flexible lines over early corners.
