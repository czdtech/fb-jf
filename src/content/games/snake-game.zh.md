...
locale: zh
urlstr: snake-game
title: '[ZH TRANSLATION NEEDED] Snake Game'
description: >-
  [ZH TRANSLATION NEEDED] Snake Game is the classic arcade game where players
  control a growing snake to eat food items while avoiding collisions with walls
  and the snake's own body, aiming to achieve the highest possible score.
