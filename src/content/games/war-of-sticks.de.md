...
- **Armee aufbauen:** Stelle verschiedene Stickman‑Einheiten auf, zum Beispiel:
    - **Schildträger:** Starke Frontlinie, die Schaden abfängt.
    - **Bogenschützen:** Fernkämpfer, die hinter der Front großen Schaden anrichten.
    - **Barbaren:** Aggressive Nahkämpfer für schnellen Durchbruch.
...
Du musst deine Basis verteidigen, gleichzeitig deine Armee stärken und schließlich die feindliche Basis zerstören, um das Gebiet vom roten Imperium zurückzuerobern.

**Wie komme ich an mehr Gold?**  
Bild mehr Miner aus und schicke sie an die Goldquelle. Wenn möglich, nutze Konvertierungen von Stein zu Gold, um Engpässe zu überbrücken.
