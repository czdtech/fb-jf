...
locale: es
title: Hobo
seoTitle: Juega a Hobo en línea gratis | FiddleBops
description: >-
...
aplastando enemigos a base de puñetazos, patadas, agarres y cadenas de combos
que vas desbloqueando. Las armas del entorno, los objetos arrojadizos y los
peligros del escenario aportan variedad, mientras que los jefes ponen a prueba
 tu control de masas y tu sincronización. Gestionar bien la salud y la resistencia, y
...
- Usa objetos recogibles y arrojadizos para debilitar grupos desde la distancia.
...
- Mantén a los enemigos en un solo lado de tu personaje para evitar que te
  rodeen.
- Usa agarres contra objetivos aislados para eliminarlos rápido cuando la
  multitud se haya reducido.
