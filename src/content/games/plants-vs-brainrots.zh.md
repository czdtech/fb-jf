...
2.  **了解每种 Brainrot 的特性：** 不同脑腐怪代表不同迷因，对应不同能力与强度：  
    *   **Skibidi Toilet：** 基础小怪，移动速度快但血量较低，一排 **Common Sense Shooters**（类似豌豆射手）即可应对。  
    *   **Sigmas：** 扮演“坦克”角色，对应高防御单位，类似路锥僵尸或铁桶僵尸，需要多排火力或利用 **Fact-Checker Wall**（类似坚果墙）拖延时间集中输出。  
    *   **The Rizzler / Gyatt 等特殊单位：** 可能会对你的植物造成短暂失能、“魅惑”或绕过部分防线，应优先用高爆发植物集火处理。

3.  **经典阵型思路：** 依旧推荐“后经济、中输出、前防御”的经典布局：  
    *   **后排：** 大面积种植 Focus Flowers，保证中后期经济。  
    *   **中排：** 放置主力输出植物，如 Common Sense Shooters 以及范围爆炸的 **Meme-Eraser Cherries**。  
    *   **前排：** 用 Fact-Checker Wall 等高耐久植物挡在最前面，争取足够输出时间。
