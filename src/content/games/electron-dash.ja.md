...
title: '[JA TRANSLATION NEEDED] Electron Dash'
description: >-
  [JA TRANSLATION NEEDED] Electron Dash is a fast tunnel runner: jump, dash, and
...
### Overview
[JA TRANSLATION NEEDED] Fast tunnel runner: sprint along cylinders and platforms, leap gaps, and dash across floating tiles while the pace steadily increases.
...
[JA TRANSLATION NEEDED]   A: Many hosts use procedural sections, so runs differ.
- Q: What counts as failure?  
[JA TRANSLATION NEEDED]   A: Falling, hitting lasers, or being pushed off by rings.
- Q: Any upgrades?  
[JA TRANSLATION NEEDED]   A: Some hosts add gem unlocks or cosmetics; core loop is distance.
