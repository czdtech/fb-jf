...
2.  Work from prefixes/suffixes (re‑, un‑, ‑ing, ‑ed) to inflate options.
3.  Use letter frequency — E/A/R/S/T appear more; hunt words around them.
4.  Bank bonus words for hints in late boards.
5.  When stuck, reshuffle mental order (middle‑out) to discover new strings.
