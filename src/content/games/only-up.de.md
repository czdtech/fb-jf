...
title: '[DE] Only Up'
description: >-
  [DE] Only Up is a challenging 3D platformer where players must meticulously
...
1.  **[DE]** **Meticulous Observation**: Before each jump, carefully observe the position, distance, and material of the next landing spot, and plan the optimal route.
2.  **[DE]** **Master Jump Rhythm**: Different objects may require different jump strengths and timings; familiarize yourself with the character's jumping feel.
3.  **[DE]** **Utilize Environment**: Some seemingly impossible jumps might require using small objects in the environment for assistance, or finding hidden paths.
4.  **[DE]** **Stay Calm**: Don't get discouraged by multiple failures; staying calm helps improve operational stability and precision.
5.  **[DE]** **Learn from Experience**: Every fall is an opportunity to learn; remember where you failed to avoid repeating mistakes.

### How to Play

*   **[DE]** **Movement**: Use WASD or arrow keys to control character movement.
*   **[DE]** **Jump**: Spacebar for jumping.
*   **[DE]** **Sprint**: Some game versions may offer a sprint function, often combined with jumping for longer leaps (e.g., Shift + Spacebar).
*   **[DE]** **Camera Control**: Use the mouse to control the camera, allowing for better observation of the surroundings and route planning.

### Frequently Asked Questions

1.  **[DE]** **Q: Does the game have save points?**
