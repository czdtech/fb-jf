...
title: '[KO] Basket Battle'
description: >-
  [KO] Basket Battle is a physics basketball duel — aim arcs, box out, and
...
1.  **[KO]** Arc aiming: Higher arcs drop softer and score more consistently.
2.  **[KO]** Rebounds: Box out after shots to secure second‑chance points.
3.  **[KO]** Tempo: Shoot quickly off rebounds before defense resets.
4.  **[KO]** Shot selection: Avoid flat drives from deep; step in for better odds.
5.  **[KO]** Mind wind (if any): Offset aim when wind appears.
