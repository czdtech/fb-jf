...
title: '[FR] Liquid puzzle sort colors'
description: >-
  [FR] Liquid puzzle sort colors is a relaxing pour‑sort — decant liquids by
...
1.  **[FR]** Keep two buffers empty if possible; they’re your escape valves.
2.  **[FR]** Build from completed bottles outward; lock finished colors early.
3.  **[FR]** Top‑down pours: Move top colors to consolidate stacks before addressing deep layers.
4.  **[FR]** Avoid burying singletons; surface odd colors early to prevent traps.
5.  **[FR]** Deadlock check: If all moves reverse progress, undo and change the pour order.
