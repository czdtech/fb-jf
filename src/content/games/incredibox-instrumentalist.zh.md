...
Mod 的主题是对**全球乐器**的庆祝，创造一个**纯器乐**且充满活力的世界音乐管弦乐队。所有 20 个声音图标代表来自各种文化和流派的多样化真实乐器，包括键盘、手风琴、沙锤、弦乐器和各种打击乐器。
...
1.  **了解器乐部分**：所有 20 个图标代表一个完整的管弦乐队。
    *   **节奏部分（打击乐）**：这形成基础。它包括手鼓、响板、沙锤、铃鼓、三角铁和各种摇铃（包括一个类似足球的,可能是 caxixi 或类似的摇铃）等图标。
    *   **和声与贝斯（和弦/基础）**：这部分提供和声结构。它包括键盘/风琴和手风琴等乐器。
    *   **旋律（主奏）**：这些是演奏主旋律的主奏乐器。寻找代表小号、长笛、各种弦乐器（如科拉琴或曼陀林）和陶笛的图标。
    *   **纹理乐器**：这个类别包括添加独特音色和节奏复杂性的乐器,如刮瓜（刮擦器）和卡祖笛。

2. **从节奏开始构建**：坚实的基础是关键。首先召唤几个打击乐器来建立稳定的律动。简单的鼓和沙锤组合可以完美地奠定舞台。

3. **添加和声层**：一旦你的节奏设定好,引入一个可以演奏和弦的乐器,如键盘或手风琴。这将为你的作品增加深度和和声结构。

4. **编织旋律**：有了基础,是时候让主奏乐器大放异彩了。在你的节奏和和声之上叠加小号或长笛旋律,创作一首完整的歌曲。
...
### **操作指南**
<!-- i18n:controls:keys -->
- 按键（对齐）： `Drag` `drop` `click` `Click`

这个 Mod 对经典 Incredibox 操作有独特的诠释。

- **添加乐器**：从底部**拖动**一个声音图标并**放置**到舞台上的一个空槽位。乐器本身会出现并开始演奏。
