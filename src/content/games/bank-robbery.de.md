...
locale: de
urlstr: bank-robbery
title: '[DE] Bank Robbery'
description: >-
  [DE] A detailed guide for the team-based FPS game Bank Robbery 2. Learn
...
1.  **[DE]** **Plan Your Entry:** Don't just rush the front door. Scout for alternative entry points like back alleys, side doors, or even rooftop access. A coordinated, multi-pronged attack can confuse the police.
2.  **[DE]** **Assign Roles:** Don't have everyone do the same thing. Designate specific roles: one or two players to place and guard the drill, one to watch the main entrance, and another to cover flanking routes.
3.  **[DE]** **Protect the Drill:** The drill is your key to the money, but it's noisy and takes time, making it a magnet for Cops. Set up defensive positions around the drilling area and hold your ground.
4.  **[DE]** **The Escape is a Separate Mission:** Getting the money is only half the battle. Once you have the cash bags, you become a high-priority target. Plan your escape route in advance and consider having a designated getaway driver ready with a vehicle.
5.  **[DE]** **Upgrade Your Gear:** Use the money you earn from successful heists to buy better weapons, stronger armor, and useful tools like C4 for faster breaching.

#### For Cops:

1.  **[DE]** **Secure All Entrances:** At the start of the round, don't just camp the main lobby. Spread out to cover all potential points of entry. A single robber slipping through can start a drill and put your team at a disadvantage.
2.  **[DE]** **Communicate and Call Out:** Use the team chat to report enemy locations. Announce where the robbers are drilling ("Drill on the main vault!") so your team can converge on the threat.
3.  **[DE]** **Coordinated Retakes:** If robbers have taken control of an area, don't rush in one by one. Group up and breach the room together from multiple angles to overwhelm them.
4.  **[DE]** **Prioritize Defusing the Drill:** If a drill is active, stopping it is your top priority. Provide cover for a teammate who is attempting to defuse it, as they will be completely vulnerable during the process.
5.  **[DE]** **Cut Off the Escape:** If the robbers manage to grab the money, your objective shifts to interception. Use police cars to chase them down or set up roadblocks on the path to their getaway point.

### Controls Guide

The game uses standard first-person shooter controls common on its platform (Roblox for PC).

*   **[DE]** **`W`, `A`, `S`, `D` Keys**: Move your character.
*   **[DE]** **Mouse**: Aim and control the camera.
*   **[DE]** **`Left Mouse Button`**: Fire your weapon.
*   **[DE]** **`Right Mouse Button`**: Aim down sights (ADS).
*   **[DE]** **`R` Key**: Reload your weapon.
*   **[DE]** **`Left-Shift` Key**: Sprint.
*   **[DE]** **`Spacebar`**: Jump.
*   **[DE]** **`E` or `F` Key**: Interact with objects (e.g., place/defuse a drill, pick up cash, enter a vehicle).
*   **[DE]** **Number Keys (`1`, `2`, `3`...)**: Switch between your equipped weapons and items.
*   **[DE]** **`C` Key**: Crouch (if available in the specific version).
