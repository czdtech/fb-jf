...
locale: es
urlstr: train-miner
title: '[ES] Train Miner'
description: >-
  [ES] Train Miner is a rail‑laying puzzler — lay tracks, collect ore, and reach
...
1.  **[ES]** Exit first: Ensure a viable exit path before optional ore.
2.  **[ES]** Turn economy: Prefer straights; reserve turns for mandatory bends.
3.  **[ES]** Branch spurs: Add short spurs to grab side ore and rejoin main line.
4.  **[ES]** Test rides: Simulate routes mentally before launching.
5.  **[ES]** Undo quickly after dead‑end sightings.
