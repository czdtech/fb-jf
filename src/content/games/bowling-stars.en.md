...
2.  Control the hook: Add gentle curve so the ball enters the pocket at an angle for better pin action.
3.  Spare system: Memorize spare angles (e.g., 7‑pin and 10‑pin) and use cross‑lane shots.
