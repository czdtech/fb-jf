...
title: '[FR] Brain Test 2: Tricky Stories'
description: >-
  [FR] Here's your chance to play Brain Test 2: Tricky Stories Game. Have fun
  with this one!
...
*   **[FR]** **Story-Driven Levels:** The game is structured around various characters and their adventures, such as Agent Smith's mission, Emily's farm life, and Monster Hunter Joe's escapades. Each chapter tells a short story, and players advance the plot by solving puzzles.
*   **[FR]** **Diverse Puzzle Design:** The puzzles are incredibly varied, covering logic, observation, common sense (and sometimes, the opposite of common sense), and creativity.
*   **[FR]** **Highly Interactive Controls:** Players need to interact with game elements through a variety of actions, including tapping, dragging, merging, shaking the phone, tilting the device, and pinching to zoom. Sometimes, the solution is hidden within the level's title text or the UI itself.
*   **[FR]** **Humorous Art Style:** The game features a clean and vibrant cartoon art style. The characters and animations are full of humor, and even the failure animations are often amusing.
*   **[FR]** **Hint System:** If a player gets stuck on a level, they can use the in-game "light bulb" hints to get a clue or even skip the level entirely (usually by watching an ad).
...
*   **[FR]** **Think Outside the Box:** This is the most crucial principle. Do not apply everyday logic to the problems. The answer is often the option you initially dismissed.
*   **[FR]** **Interact with Everything on the Screen:**
    *   **[FR]** **Drag:** Try dragging every object, including background elements like clouds, the sun, or even the words in the question.
    *   **[FR]** **Combine:** Attempt to drag two or more items together to see if they can be combined into a new tool.
    *   **[FR]** **Tap/Rub:** Repeatedly tap or rub an object; it might trigger a hidden effect.
*   **[FR]** **Read the Question Carefully:** The text of the question itself is often a key clue. Pay attention to puns, keywords, or hidden instructions.
*   **[FR]** **Utilize Your Phone's Hardware Features:**
    *   **[FR]** **Shake:** Many levels require you to shake your phone to make objects fall or move.
    *   **[FR]** **Tilt:** Tilting your device can change the direction of gravity, affecting liquids or movable objects.
    *   **[FR]** **Volume Buttons:** A few puzzles might require you to interact with your phone's volume keys.
    *   **[FR]** **Rotate/Flip:** Turning your phone upside down or rotating it can also be a solution.
*   **[FR]** **Pay Attention to Details and Numbers:** Carefully observe all details in the scene. Count the number of objects and check if anything is hidden behind something else.
*   **[FR]** **Don't Be Afraid to Fail:** The game encourages trial and error. Trying different approaches is a necessary part of finding the correct solution.
*   **[FR]** **Use the Hint System Wisely:** If you are genuinely stuck for a long time, use a light bulb hint. It will give you a critical clue rather than the direct answer, helping to guide your thought process.
...
1.  **[FR]** As a reward for completing certain levels or chapters.
2.  **[FR]** Through daily login bonuses.
3.  **[FR]** By watching optional rewarded video ads.
4.  **[FR]** By purchasing them directly via in-app purchases.
