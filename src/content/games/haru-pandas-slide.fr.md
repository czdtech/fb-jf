...
title: '[FR] Haru Pandas Slide'
description: >-
  [FR] Haru Pandas Slide is a chill slider — slide tiles to reassemble panda
...
1.  **[FR]** Frame first: Complete the border to reduce search complexity.
2.  **[FR]** Solve bands: Reassemble distinct color bands (sky/forest/pandas) one at a time.
3.  **[FR]** Three‑move cycles: Use 3‑tile cycles to rotate positions without breaking placed areas.
4.  **[FR]** Lock awareness: Route moves around locked tiles; treat them as anchors.
5.  **[FR]** Minimal moves: Plan ahead to avoid undoing progress.
