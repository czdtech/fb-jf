...
*Cookie Clicker（クッキークリッカー）*は、2013年にOrteil氏によって公開され、世界中で社会現象を巻き起こしたブラウザゲームです。このゲームがきっかけで「クリッカー系・放置系ゲーム」というジャンルが爆発的に普及しました。

画面左側の巨大なクッキーをクリックしてクッキーを生成し、そのクッキーを通貨として「カーソル」「グランマ（おばあちゃん）」「農場」「工場」「錬金術ラボ」「タイムマシン」、果ては「反物質コンデンサ」などの施設を購入します。
最初は手動ですが、すぐに毎秒数百万、数十億、数京という単位で自動的にクッキーが生産されるようになります。皮肉の効いたユーモア、隠された実績、そして「グランマポカリプス」と呼ばれる不気味なイベントなど、深遠な世界観も魅力です。
...
*   **角砂糖（英: Sugar Lumps）：** 約24時間に1個入手できます。施設レベルを上げてその施設のCpSに永久+1%を付けるなど、貴重なリソースなので計画的に使いましょう。
...
**3. 角砂糖（英: Sugar Lumps）は最初に何に使うべき？**
