...
title: '[ES] Run 3'
description: >-
  [ES] Run 3 is an endless running game set in space where players control an
...
1.  **[ES]** **Master Jumping Timing**: Learn to jump at the right moments to avoid gaps and obstacles.
2.  **[ES]** **Utilize Walls**: You can run on tunnel walls and ceilings, making full use of 3D space.
3.  **[ES]** **Choose Appropriate Characters**: Different characters have different abilities; choose the one suitable for the current level.
4.  **[ES]** **Plan Your Path**: Observe obstacles ahead and plan the optimal running route.
5.  **[ES]** **Maintain Rhythm**: Keep a steady running rhythm, avoiding hasty operations that lead to mistakes.

### How to Play

*   **[ES]** **Movement**: Use left and right arrow keys to control character's left and right movement.
*   **[ES]** **Jump**: Use spacebar or up arrow key to make the character jump.
*   **[ES]** **Direction Change**: In the tunnel, you can change gravity direction to run on walls and ceilings.

### Frequently Asked Questions

1.  **[ES]** **Q: How do I run on walls?**
