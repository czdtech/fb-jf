...
title: '[ES] Tiger Run'
description: >-
  [ES] Tiger Run is a jungle runner — dash, jump, and slide to dodge obstacles
  and collect coins.
...
1.  **[ES]** Eyes up: Look ahead to prepare lane swaps early.
2.  **[ES]** Priority safety: Skip side coins when gaps are tight.
3.  **[ES]** Memorize sets: Common obstacle patterns repeat—use them to pre‑position.
4.  **[ES]** Smooth inputs: Quick, small moves reduce overcorrection at high speed.
5.  **[ES]** Power‑ups: Save shields/magnets for dense sections.
