...
seoTitle: 免费在线玩 Archery World Tour 射箭世界巡回赛 | FiddleBops
...
### 操作指南
<!-- i18n:controls:keys -->
- 按键（对齐）： `mouse` `Click` `hold` `left` `button` `hold` `mouse`
...
*   **问：带风的关卡该怎么瞄？**
    *   答：** 需要朝着与风相反的方向稍微偏一点：比如风强烈向右吹，就把准星往左侧偏。风越大，偏移越多。
<!-- i18n:faq:id=faq:archery:q-why-did-my-arrow-40c5ad4d -->
*   **问：为什么箭总是打在靶心下方？**
    *   答：** 这是重力造成的自然下坠，尤其在远距离靶位上更明显。把瞄准点稍微抬高一些再试。
<!-- i18n:faq:id=faq:archery:q-what-is-the-goal-ab58581b -->
*   **问：本作的目标是什么？**
    *   答：** 在限定箭数或回合内打出尽可能高的总分。越接近靶心得分越高，稳定命中比偶尔“神箭”更关键。
