...
title: '[FR] Jewel Duel'
description: >-
  [FR] Jewel Duel mixes match‑3 with RPG — swap to attack/defend, trigger
...
1.  **[FR]** Match intent: Prioritize color that fuels your needed action (attack vs heal vs shield).
2.  **[FR]** Turn tempo: Deny enemy ult turns by breaking shields or stuns before their phase.
3.  **[FR]** Setup cascades: Clear low‑impact gems now to prepare high‑value cascades next turn.
4.  **[FR]** Targeting: Focus one enemy at a time to remove damage sources.
5.  **[FR]** Boss mechanics: Read tooltips; some require special matches or row clears.
