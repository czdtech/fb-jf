...
title: '[ES] Brain Test 3: Tricky Quests'
description: >-
  [ES] Here's your chance to play Brain Test 3: Tricky Quests Game. Have fun
  with this one!
...
*   **Checklist for When You're Stuck:**
    1.   **[ES]** Have I interacted with every element in the scene? (Tapping, dragging, rubbing, etc.)
    2.   **[ES]** Is there an item in my backpack that I can use here?
    3.   **[ES]** Can I combine items in my backpack to create a new tool?
    4.   **[ES]** Do I need to return to a previous scene to find a missed item?
    5.   **[ES]** Did I miss any key information in the dialogue?
