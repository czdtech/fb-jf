...
title: '[FR] Jungle Match Puzzle'
description: >-
  [FR] Jungle Match Puzzle is a lively match‑3 — clear blockers, chain
...
1.  **[FR]** Objective‑first: Prioritize blocker clears and collect goals before pure scoring.
2.  **[FR]** Bottom clears: Work from the bottom to spawn cascades that remove blockers above.
3.  **[FR]** Power‑up combos: Merge for board‑wide effects; save strong combos for clustered blockers.
4.  **[FR]** Move economy: Map 2–3 moves ahead; avoid isolating colors near walls.
5.  **[FR]** Hazard awareness: Sticky tiles require adjacent matches; plan detours.
