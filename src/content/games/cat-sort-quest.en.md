...
2.  Finish colors early when it frees another perch (snowball effect).
3.  Surface singles: Don’t bury unique colors under mixed stacks.
4.  Two‑step preview: Simulate next moves to avoid creating softlocks.
5.  Merge partial stacks of the same color promptly to release space.
