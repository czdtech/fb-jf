...
title: '[FR] Red Ball 4'
description: >-
  [FR] Red Ball 4 is a physics-based platformer game where players control a red
...
1.  **[FR]** **Master Physics Properties**: Utilize the red ball's bouncing and rolling characteristics to traverse obstacles and reach targets.
2.  **[FR]** **Timing Mastery**: Many obstacles require precise timing to pass through; observe patterns and act at the right moment.
3.  **[FR]** **Collect Stars**: Each level has hidden stars; collecting them can unlock additional content.
4.  **[FR]** **Defeat Enemies**: Jump on square enemies to defeat them, but be careful of their attack patterns.
5.  **[FR]** **Use Mechanisms**: Learn to use buttons, switches, and other mechanisms to open new paths.

### How to Play

*   **[FR]** **Move**: Use left and right arrow keys to control the red ball's left and right movement.
*   **[FR]** **Jump**: Use the up arrow key or spacebar to make the red ball jump.
*   **[FR]** **Roll**: Utilize gravity to naturally roll on slopes, or accelerate by continuously pressing arrow keys.

### Frequently Asked Questions

1.  **[FR]** **Q: How do I defeat square enemies?**
**A**: Jump on them from above to defeat them, but avoid touching them from the side or below.
2.  **[FR]** **Q: What are stars used for?**
**A**: Collecting stars can unlock new levels and game content, making them an important element for completing the game.
3.  **[FR]** **Q: What if I get stuck on a level?**
...
4.  **[FR]** **Q: How many levels are there in the game?**
