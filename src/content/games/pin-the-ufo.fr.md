...
locale: fr
urlstr: pin-the-ufo
title: '[FR] Pin the UFO'
description: >-
  [FR] Master the 'pull the pin' puzzle game, Pin the UFO. This guide provides
...
*   **[FR]** **Color Spreading**: Some aliens start off colorless (white or grey). They must come into contact with the colored aliens to gain color before they can be collected.
*   **[FR]** **Obstacles**: Levels often contain hazards like bombs or explosives. The aliens must be kept away from these dangers.
*   **[FR]** **Physics**: The game is based on simple physics. You must understand how the balls will fall, mix, and flow once a pin is removed.
...
1.  **[FR]** **Plan Before You Pull**: This is the most important rule. Do not pull pins randomly. Take a moment to look at the entire setup and mentally trace the path the aliens will take for each possible pin-pull.
2.  **[FR]** **Color the Grey Aliens First**: Your top priority in most levels is to ensure the colorless aliens mix with the colored ones. Often, you will need to pull a pin that allows the colored aliens to drop down onto the colorless ones *before* you release them all towards the exit.
3.  **[FR]** **Isolate and Neutralize Bombs**: If there are bombs, the puzzle is usually about finding a way to either drop the bombs into a separate, harmless area, or to release the aliens in a way that they flow around the bombs. Never drop the aliens directly onto bombs.
4.  **[FR]** **The Order Matters**: The sequence in which you pull the pins is everything. Pulling pin A before pin B might lead to success, while pulling B before A leads to failure. Think of it like a combination lock.
5.  **[FR]** **Look for Separators**: Some pins are there just to keep things separate (e.g., bombs from aliens, colored aliens from colorless ones). Understand the function of each pin before you remove it.

### **Controls Guide**

The controls are extremely simple and designed for one-touch mobile gameplay.

*   **[FR]** **Pull a Pin**: **Click and drag** the pin you want to remove out of its slot. Alternatively, a simple **tap** on the end of the pin often works as well.
