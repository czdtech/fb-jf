...
title: '[ES] Basket Battle'
description: >-
  [ES] Basket Battle is a physics basketball duel — aim arcs, box out, and
...
1.  **[ES]** Arc aiming: Higher arcs drop softer and score more consistently.
2.  **[ES]** Rebounds: Box out after shots to secure second‑chance points.
3.  **[ES]** Tempo: Shoot quickly off rebounds before defense resets.
4.  **[ES]** Shot selection: Avoid flat drives from deep; step in for better odds.
5.  **[ES]** Mind wind (if any): Offset aim when wind appears.
