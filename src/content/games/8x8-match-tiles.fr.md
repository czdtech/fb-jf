...
title: '[FR] 8x8 Match Tiles'
description: >-
  [FR] 8x8 Match Tiles is a clean tile matcher — pair identical tiles, clear
...
1.  **[FR]** Open lanes: Keep paths clear to expose deeper tiles.
2.  **[FR]** Prioritize scarce tiles before they clog the board.
3.  **[FR]** Chain clears from the bottom to trigger reveals.
4.  **[FR]** Avoid isolating singles near corners.
5.  **[FR]** Use hints sparingly if available.
