...
《Jet Boi》是一款节奏紧凑的空中控制类对战射击。两名玩家操控角色在多层平台之间利用喷气背包进行短促上升和位移，争夺地图上刷新出的各类枪械，并通过射击或碰撞击退把对方打出平台边缘或直接击倒。想在有限燃料下保持空中优势，就要学会用短促喷射微调高度、控制后坐力、掌握武器刷新节奏。

<!-- i18n:section:how-to-play -->
### 游戏玩法

- 使用短点喷气在平台间悬停与小幅调整位置，不要一次性把燃料全部喷完。  
- 优先争抢武器刷新点，占据高处后从上往下压制，对射角度更安全。  
- 在平台边缘附近利用武器击退或近身撞击，把对手直接“打飞出场”，往往比单纯比拼血量更高效。  
...
- 即使暂时不需要武器，也可以提前踩掉武器箱，让对手更难拿到装备，等于在资源层面“反补”对方。  
- 地图顶部平台往往是最有利的位置，可以同时观察两侧动向，并拥有更多进攻和撤退路线，开局不妨优先抢占制高点。  
...
- Q: 如何更省燃料地保持在空中？  
  A: 采用节奏感强的短点喷气方式，让角色在一个高度区间内缓慢上下浮动，而不是一次性长按喷气把燃料烧光。  

<!-- i18n:faq:id=faq:jet-boi:what-is-the-best-way-8b95a599 -->
- Q: 什么是最稳妥的“收头方式”？  
  A: 在平台边缘附近用高击退武器或近身连击把对手直接打出边界，比在场中间单纯堆伤害要安全得多。  

<!-- i18n:faq:id=faq:jet-boi:can-i-remap-keys-for-f8be220d -->
- Q: 可以自定义两名玩家的键位吗？  
  A: 许多托管版本在开始游戏前都提供按键设定界面，你可以根据手感调整双方的键位分布。
