...
title: '[ES] Flames & Fortune'
description: >-
  [ES] Flames & Fortune is a tactical card‑style battler — manage hands, trade
...
1.  **[ES]** Curve planning: Spend your turn’s resources cleanly; avoid floating energy.
2.  **[ES]** Value trades: Use small cards to set up big swings next turn.
3.  **[ES]** Read intents: Counter incoming damage with blocks or denies.
4.  **[ES]** Deck focus: Prioritize consistent synergies over scattered picks.
5.  **[ES]** Mulligan wisely: If available, mulligan slow hands against fast foes.
