...
title: '[KO] Classic Solitaire'
description: >-
  [KO] Enjoy the timeless card game of Classic Solitaire (Klondike).
...
2.  **[KO]** **Core Rules & Strategy:**
    ...
    *   **[KO]** **Building on the Tableau:** You can move cards between columns in the tableau. Cards must be placed on a card of the next-highest rank and of the opposite color (e.g., a black 7 can be placed on a red 8).
