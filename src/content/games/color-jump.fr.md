...
title: '[FR] Color Jump'
description: >-
  [FR] Color Jump is a one‑tap runner — match colors, time jumps, and thread
...
1.  **[FR]** Read two obstacles ahead; don’t fixate on the nearest gate.
2.  **[FR]** Keep a steady tap cadence; late jumps often dodge low obstacles better.
3.  **[FR]** Skip risky coins when alignment is off.
4.  **[FR]** Practice color order patterns if they loop.
5.  **[FR]** Use sound cues to stabilize timing on dense sets.
