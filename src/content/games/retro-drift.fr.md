...
locale: fr
urlstr: retro-drift
title: '[FR] Retro Drift'
description: >-
  [FR] Retro Drift is an old‑school top‑down drifter — feather throttle, manage
...
1.  **[FR]** Enter slow, exit fast: Sacrifice a bit of entry speed to maximize exit traction and next corner setup.
2.  **[FR]** Feather throttle: Short pulses keep traction while preserving the slide.
3.  **[FR]** One drift, many corners: Link consecutive corners by planning line and throttle in advance.
4.  **[FR]** Recover early: If the rear steps out too far, reduce throttle and steer into the slide before it spins.
5.  **[FR]** Learn layouts: Repetition builds muscle memory for braking points and apex timing.
