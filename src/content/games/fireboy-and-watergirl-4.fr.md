...
title: '[FR] Fireboy And Watergirl 4'
description: >-
  [FR] The definitive guide to Fireboy and Watergirl 4: The Crystal Temple.
...
*   **[FR]** **White Portals**: These are two-way portals. Entering a white-edged portal will transport you to the other corresponding white portal, and you can travel back and forth.
*   **[FR]** **Colored Portals (e.g., Black)**: These are one-way portals. You can only travel through them in one direction.
...
1.  **[FR]** **Master the Portals**: This is the most crucial skill for this game. Before moving, identify where each portal leads. Pay close attention to which ones are one-way, as entering one might trap a character until the other player can open a new path.
2.  **[FR]** **Momentum is Conserved**: When you enter a portal with speed, you will exit the corresponding portal with the same speed and in the same direction. Use this to your advantage to cross large gaps or reach high ledges immediately after teleporting.
3.  **[FR]** **Plan Your Route Through Portals**: Often, one character must go through a series of portals to activate a switch that allows the other character to proceed. Trace the path with your eyes before committing to a sequence of teleports.
4.  **[FR]** **Standard Co-op Rules Apply**: Communication remains vital. Coordinate who pushes boxes, who holds down buttons, and who flips levers. Many puzzles are impossible without precise, synchronized actions.
5.  **[FR]** **Look for Symmetrical Puzzles**: Many levels have a symmetrical design. What one character does on one side of the screen often needs to be mirrored by the other character on the opposite side, frequently using portals to assist each other.
6.  **[FR]** **Don't Rush One-Way Portals**: Think carefully before sending a character through a one-way portal. Ensure there is a way for them to either continue forward or for the other player to eventually open a path for them to return.
...
**For Watergirl:**
*   **[FR]** **Move Left**: `Left Arrow` key
*   **[FR]** **Move Right**: `Right Arrow` key
