...
title: '[FR] Chess Grandmaster'
description: >-
  [FR] Chess Grandmaster offers classic chess — learn openings, calculate
...
1.  **[FR]** Openings: Develop minor pieces, castle early, and fight for the center (e4/d4).
2.  **[FR]** Tactics: Always scan checks, captures, threats on every move (“CCT”).
3.  **[FR]** Structure: Avoid doubled/isolation if possible; create pawn majorities you can push.
4.  **[FR]** Endgames: Activate your king; know basic mates (KQ vs K, KR vs K) and pawn endings (opposition/zugzwang).
5.  **[FR]** Time control: Play simple, safe moves when low on time.
