...
- Q: 더 이상 짝이 없는 것 같은데 어떻게 해야 하나요?

  A: 셔플 기능이 있다면 이를 사용해 보드를 재배열해야 합니다. 셔플이 없다면, 초반의 선택이 막힌 원인이 되었을 수 있으니 다른 시작 패턴으로 다시 도전해 보세요.

<!-- i18n:faq:id=faq:collect-same-thing:timed-or-move-limits-5e0f38ca -->
- Q: 시간 제한과 이동 제한은 어떻게 다르게 플레이해야 하나요?

  A: 시간 제한 모드에서는 빠른 시야 스캔과 손속도가 중요하므로, 작은 실수를 크게 신경 쓰지 말고 우선 눈에 보이는 쌍부터 처리하는 것이 좋습니다. 이동 제한 모드에서는 한 쌍을 제거할 때 얼마나 많은 공간과 새로운 쌍이 열리는지까지 고려해 더 "가성비 좋은" 선택을 해야 합니다.

<!-- i18n:faq:id=faq:collect-same-thing:any-scoring-tips-98d70617 -->
- Q: 점수를 더 많이 얻으려면 어떻게 해야 하나요?

  A: 연속해서 빠르게 쌍을 맞추면 콤보 보너스를 주는 모드가 많습니다. 보드를 어느 정도 외운 뒤에는, 의도적으로 연속 매치를 이어 가며 콤보를 유지하는 것이 고득점에 도움이 됩니다.
