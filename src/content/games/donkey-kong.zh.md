...
locale: zh
urlstr: donkey-kong
title: '[ZH TRANSLATION NEEDED] Donkey Kong'
description: >-
  [ZH TRANSLATION NEEDED] Donkey Kong is a classic arcade platformer: climb
...
### Overview
[ZH TRANSLATION NEEDED] Arcade classic (1981): climb girders and ladders as Mario, dodge barrels and fireballs, and use the hammer to smash hazards while you work through the four stage types (25m–100m) to rescue Pauline. Stages repeat with faster patterns after each level. 
...
[ZH TRANSLATION NEEDED]   A: Four: Girders (25m), Conveyors (50m), Elevators (75m), and Rivets (100m).
- Q: Does the game loop?  
[ZH TRANSLATION NEEDED]   A: Yes, stages repeat at higher difficulty after each level.
- Q: What ends a run?  
[ZH TRANSLATION NEEDED]   A: Collisions, falling too far, or the bonus timer reaching zero.
