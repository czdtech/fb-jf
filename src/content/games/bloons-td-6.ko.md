...
-   **새로운 블룬 타입**: 에너지·불·플라즈마 공격에 면역인 **Purple Bloon
    ...
    **B.A.D. (Big Airship of Doom 표기)** 등이 새로 등장합니다.
-   **시야(Line of Sight 표기) 시스템**: 처음으로 맵 위의 3D 오브젝트가 일부 타워의
...
-   **위협 요소별 대처법 익히기**  
    ...
    -   **DDT**: 속도가 매우 빠르고 Camo·Lead·Black 특성을 한꺼번에 지닌 최종
        ...
        (Prince of Darkness 표기), 0/2/5 **Ice Monkey** (Icicle Impale 표기), 그리고 x/3/x
        **Monkey Village** (Monkey Intelligence Bureau 표기)로 모든 블룬 타입에 대한
...
-   **Paragon을 위한 장기 플랜 세우기**  
    ...
    아니라, 그 타워들이 높은 타격 수(pop count 표기)를 기록하고 있을수록 좋습니다.
