...
locale: es
urlstr: merge-bistro
title: '[ES] Merge Bistro'
description: >-
  [ES] Merge Bistro is a cozy merge‑management — combine ingredients, fulfill
...
1.  **[ES]** Queue reading: Prep items for upcoming orders to avoid idle waits.
2.  **[ES]** Board economy: Keep a lane for bases and a lane for high tiers; avoid clogging.
3.  **[ES]** Merge discipline: Only merge when you can immediately use or free space.
4.  **[ES]** Generators: Upgrade generators that feed the most common recipes first.
5.  **[ES]** Delivery timing: Turn in batches to trigger combo rewards.
