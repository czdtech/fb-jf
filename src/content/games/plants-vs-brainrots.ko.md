...
1.  **"포커스" 경제부터 구축하기**  
    ...
    **포커스 플라워(Focus Flowers 표기)**가 생성합니다. 어떤 스테이지든
...
3.  **배치의 미학 – 라인 구성을 정석으로**  
    ...
    * **후열(Back Rows 표기)**: 포커스 플라워처럼 자원을 생산하는 식물을
      배치합니다. 적에게 쉽게 파괴되지 않도록 맨 뒤에 두는 것이
      좋습니다.  
    * **중열(Middle Rows 표기)**: **Common Sense Shooters**, 폭발형
      **Meme-Eraser Cherries** 등 메인 공격 식물을 두는 자리입니다.  
    * **전열(Front Row 표기)**: **Fact-Checker Wall** 같은 방어용 식물을
