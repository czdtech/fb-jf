...
### 조작 방법
<!-- i18n:controls:keys -->
- 키(정렬)： `Click` `Tap` `Drag` `Drop` `Click`

- **선택:** 캐릭터를 Click 또는 Tap 해서 사운드를 미리 들어봅니다.
- **배치:** 캐릭터를 Drag 해서 무대 슬롯에 Drop 하면 활성화됩니다.
- **음소거/솔로:** 활성화된 캐릭터를 Click 해서 음소거 또는 솔로를 전환합니다.

<!-- i18n:section:faq -->
### 자주 묻는 질문

- <!-- i18n:faq:id=faq:ayocs-sprunkr:is-it-free-9d8e3b2a -->
  **AYOCS Sprunkr는 무료인가요?** 네, 온라인에서 무료로 즐길 수 있는 모드입니다.
- <!-- i18n:faq:id=faq:ayocs-sprunkr:mobile-compatible-2a8d3c4e -->
  **모바일에서도 플레이할 수 있나요?** 네, 데스크톱과 모바일 브라우저 모두에 최적화되어 있습니다.
