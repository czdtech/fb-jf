...
title: '[FR] PAC-MAN'
description: >-
  [FR] PAC-MAN is a classic arcade maze game where players control Pac-Man,
...
1.  **[FR]** **Understand Ghost Behavior**: Each ghost has its unique AI pattern. Blinky (red) is a chaser, Pinky (pink) tries to ambush, Inky (light blue) has more complex movements, and Clyde (orange) tends to wander randomly.
2.  **[FR]** **Utilize Power Pellets**: After eating a power pellet, immediately chase and eat the ghosts for high scores. The more ghosts eaten, the higher the score.
3.  **[FR]** **Plan Routes**: When moving through the maze, plan your route in advance to avoid being cornered by ghosts.
4.  **[FR]** **Use Tunnels**: The tunnels at both ends of the maze allow Pac-Man to quickly move from one side to the other, useful for evading or counter-attacking ghosts.
5.  **[FR]** **Prioritize Large Pellets**: Power pellets (large pellets) are crucial for turning the tide and should be prioritized.
...
1.  **[FR]** **Q: How many levels are there in "PAC-MAN"?**
...
2.  **[FR]** **Q: What are the names and colors of the ghosts?**
**A**: The four ghosts are: Blinky (red), Pinky (pink), Inky (light blue), and Clyde (orange).
3.  **[FR]** **Q: What happens to the ghosts after eating a power pellet?**
...
4.  **[FR]** **Q: Is the objective of the game to eat all the pellets?**
