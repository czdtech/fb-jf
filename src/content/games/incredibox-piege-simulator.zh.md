...
2. **叠加旋律**：一旦你的节拍设定好，移动到绿色图标。添加一个简单、重复且通常听起来黑暗的旋律。在陷阱音乐中，旋律通常不如节奏复杂，用于创造氛围。

3. **填满循环条**：你的目标是填满"LOOP"进度条。这是通过激活更多声音来实现的。尝试不同的组合，看看它们如何影响进度和曲目的整体感觉。
...
*   **激活/停用声音**：**点击**网格中 20 个声音图标中的任何一个。激活的图标将被突出显示，将其声音添加到循环中。再次点击将关闭它。
