...
1.  **Know Your Bonuses:** The key to a high score is using the bonus squares effectively.
    *   **DL (Double Letter):** Doubles the point value of the letter placed on it.
    *   **TL (Triple Letter):** Triples the point value of the letter placed on it.
    *   **DW (Double Word):** Doubles the score of the entire word that uses this square.
    *   **TW (Triple Word):** Triples the score of the entire word that uses this square.

2.  **Build Around the Center:** The game requires that the center star square must be occupied. Start your first word there.
