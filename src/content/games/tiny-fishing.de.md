...
locale: de
urlstr: tiny-fishing
title: '[DE] Tiny Fishing'
description: >-
  [DE] Tiny Fishing is a relaxing fishing game where players cast their line
...
1.  **[DE]** **Upgrade Fishing Line**: Prioritize upgrading line length to reach deeper waters and catch rare fish.
2.  **[DE]** **Increase Hook Value**: Upgrade hooks to increase earnings per catch, helping accumulate coins faster.
3.  **[DE]** **Offline Earnings**: The game provides offline earning features, generating some coin income even when not playing.
4.  **[DE]** **Rare Fish**: Deep water areas contain more rare and valuable fish, making equipment upgrades worthwhile.
5.  **[DE]** **Be Patient**: Fishing requires patience; wait for fish to bite, then reel in at the right time.

### How to Play

*   **[DE]** **Cast Line**: Click to start casting the fishing line into water.
*   **[DE]** **Wait**: Patiently wait for fish to bite, observing the fishing line dynamics.
*   **[DE]** **Reel In**: When fish are hooked, click to reel them in.
*   **[DE]** **Upgrade**: Use earned coins to upgrade equipment in the shop.

### Frequently Asked Questions

1.  **[DE]** **Q: How can I get more coins?**
**A**: Catch more fish, especially rare ones, and upgrade hook value to increase earnings.
2.  **[DE]** **Q: Why don't I catch fish sometimes?**
**A**: This is normal; fishing requires patience and luck, not every cast will yield results.
3.  **[DE]** **Q: How are offline earnings calculated?**
