...
mueve casilla a casilla o en líneas rectas hasta chocar con un obstáculo (según
la versión). El objetivo es cortar todas las casillas de hierba sin quedarte
...
- Examina toda la cuadrícula e identifica los cuellos de botella por los que
  tendrás que pasar exactamente una vez.
- Usa obstáculos como "paradas" para frenar deslizamientos en la casilla
  adecuada (si el movimiento es deslizante).
...
- Si el movimiento es por deslizamiento, prepara "topes" para acabar justo en
  la casilla objetivo.
