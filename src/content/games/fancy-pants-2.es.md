...
locale: es
title: Fancy Pants 2
seoTitle: Juega a Fancy Pants 2 en línea gratis | FiddleBops
description: >-
...
original, pero con niveles más amplios, nuevos enemigos y salas de reto
...
- Usa las pendientes y los saltos en pared para enlazar movimientos y superar grandes
  huecos.
- Explora el mapa en busca de coleccionables; muchos de ellos abren puertas a
  habitaciones extra.
...
- Practica las salidas de pendiente para conservar la velocidad al pasar a
  tramos planos.
- **Ventana de salto (buffer):** pulsa el botón justo antes del borde para asegurar los
