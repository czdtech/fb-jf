...
2.  Chain serves: deliver multiple orders back‑to‑back for combo tips.
3.  Upgrade bottlenecks first (e.g., grill count, prep speed).
4.  Prioritize timers: Serve expiring orders before large combos.
5.  Queue logic: Arrange workspace to minimize cursor travel.
