...
title: '[FR] Fruit Chef'
description: >-
  [FR] Fruit Chef is a swift slice‑’em‑up — chain clean cuts, avoid bombs, and
...
1.  **[FR]** Long strokes: Slice multiple fruits in a single straight line for combo bonuses.
2.  **[FR]** Don’t chase lows: Let low fruit rise into a safe arc before slicing.
3.  **[FR]** Bomb discipline: Abort swipes that would cross bombs; safety first.
4.  **[FR]** Rhythm: Maintain a comfortable cadence; panic flutters reduce accuracy.
5.  **[FR]** Power‑ups: Save slow‑mo for dense volleys.
