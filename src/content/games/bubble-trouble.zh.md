...
title: '[ZH TRANSLATION NEEDED] Bubble Trouble'
description: >-
  [ZH TRANSLATION NEEDED] Pop bouncing bubbles with your harpoon in this
  fast-paced arcade action game. Split large bubbles into smaller ones while
  avoiding contact. Master power-ups and clear all bubbles before time runs out!
iframeSrc: >-
...
[ZH TRANSLATION NEEDED] Bubble Trouble is a fast-paced arcade action game. The player controls a small, devil-like character at the bottom of the screen who can only move left and right. The objective is to clear the screen of all bouncing bubbles before the timer runs out.

[ZH TRANSLATION NEEDED] The core mechanic involves shooting a harpoon-like projectile straight up. When the harpoon hits a bubble, the bubble pops and splits into two smaller bubbles. These smaller bubbles continue to bounce around the screen. This process repeats—popping a bubble creates two smaller ones—until the bubbles reach their smallest size, at which point popping them removes them from the game completely.

[ZH TRANSLATION NEEDED] The main challenge is to avoid being touched by any of the bouncing bubbles. If a bubble hits the player's character, they lose a life. The game is lost if the player runs out of lives or if the timer reaches zero. As players progress, levels become more difficult with more bubbles, complex starting layouts, and shorter time limits. The game also features a popular two-player cooperative mode.
...
[ZH TRANSLATION NEEDED] The controls are simple and designed for quick arcade action.
...
[ZH TRANSLATION NEEDED] *(Note: Player 2 controls can sometimes vary slightly, e.g., using X and C for movement and W to shoot, depending on the version of the game.)*

### Frequently Asked Questions (FAQ)

[ZH TRANSLATION NEEDED] **1. Is it possible to shoot diagonally?**
[ZH TRANSLATION NEEDED] > No, you can only shoot your harpoon straight up. The challenge comes from positioning your character correctly underneath the moving bubbles.

[ZH TRANSLATION NEEDED] **2. How do power-ups work?**
[ZH TRANSLATION NEEDED] > Power-ups are randomly dropped when you pop a bubble. You must physically move your character over the falling icon to collect it. Most power-ups are temporary.

[ZH TRANSLATION NEEDED] **3. What is the best power-up?**
[ZH TRANSLATION NEEDED] > This is subjective, but the **Shield** is arguably the most valuable as it prevents you from losing a life. The **Sticky Harpoon** is incredibly effective for clearing multiple bubbles at once.

[ZH TRANSLATION NEEDED] **4. What happens when the timer runs out?**
[ZH TRANSLATION NEEDED] > If the timer reaches zero before you have cleared all the bubbles, you lose a life and must restart the level. If you have no lives left, the game is over.
