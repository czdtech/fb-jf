...
title: '[ES] Color Roll 3D'
description: >-
  [ES] Color Roll 3D is a satisfying unfold‑and‑fill puzzle — unroll strips in
...
1.  **[ES]** Start with the deepest/base color that covers the largest area.
2.  **[ES]** Place boundary strips to frame shapes, then fill interiors.
3.  **[ES]** Watch overlaps — avoid burying needed edges under later strips.
4.  **[ES]** Undo early when the final gaps look impossible.
5.  **[ES]** Compare with the target preview after each placement.
