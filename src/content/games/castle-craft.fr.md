...
locale: fr
title: Castle Craft
seoTitle: Jouez à Castle Craft en ligne gratuitement | FiddleBops
description: >-
  Pars dans une aventure de fusion et de construction avec Castle Craft :
...
2.  **Organise ton plateau :** ne laisse pas ton terrain s'encombrer. Garde les objets similaires regroupés pour faciliter le repérage et l'exécution de grandes fusions. Utilise l'espace ouvert stratégiquement pour manœuvrer les objets.
3.  **Concentre-toi sur les quêtes :** fais attention au journal de quêtes. Accomplir des quêtes et des commandes de villageois est le moyen principal de gagner des clés et des pièces, essentielles pour débloquer de nouvelles terres et avancer dans l'histoire.
...
*   **Fusionner des objets :** clique et fais glisser un objet sur au moins deux autres objets identiques pour effectuer une fusion.
*   **Déplacer des objets :** fais glisser un objet vers une tuile vide pour le déplacer.
