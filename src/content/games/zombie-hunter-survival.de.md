...
title: '[DE] Zombie Hunter: Survival'
description: >-
  [DE] Zombie Hunter: Survival is a tense top‑down shooter — kite hordes,
...
1.  **[DE]** Circle kite: Run wide circles to group zombies and fire into clumps.
2.  **[DE]** Reload discipline: Reload between waves or during long kites—not face‑to‑face.
3.  **[DE]** Funnel use: Fight in chokepoints for cleaner head‑on shots.
4.  **[DE]** Target priority: Eliminate fast/ranged threats first.
5.  **[DE]** Resource grabs: Take ammo/health only when routes are clear.
