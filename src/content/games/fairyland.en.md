...
2.  Clue notebooks: Note symbol sequences and color orders for later doors.
3.  Optional tasks: Complete side objectives to unlock cosmetic rewards/hints.
4.  Route planning: If a scene has backtracking, collect items along a loop to minimize travel.
5.  Mini‑game focus: Read rules carefully — many allow quick retries without penalty.
