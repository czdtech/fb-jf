...
2.  Board economy: Keep a lane for bases and a lane for high tiers; avoid clogging.
3.  Merge discipline: Only merge when you can immediately use or free space.
4.  Generators: Upgrade generators that feed the most common recipes first.
5.  Delivery timing: Turn in batches to trigger combo rewards.
