...
1.  **Composants du jeu :**
    *   **Le tableau :** la zone de jeu principale, composée de sept colonnes de cartes. La première colonne a une carte, la deuxième en a deux, et ainsi de suite jusqu'à sept. La carte du dessus de chaque colonne est face visible.
    *   **La fondation :** les quatre piles vides, généralement en haut à droite. C'est là que tu construiras tes couleurs, en commençant par l'As.
    *   **La pioche :** le paquet de cartes restantes, placé face cachée.
    *   **La défausse :** les cartes tirées de la pioche sont placées face visible ici.

2.  **Règles de base et stratégie :**
    *   **Révèle les cartes cachées :** ta première priorité devrait toujours être de révéler les cartes face cachée dans le tableau. Découvrir ces cartes te donne plus d'options.
    *   **Construire sur le tableau :** tu peux déplacer des cartes entre les colonnes du tableau. Les cartes doivent être placées sur une carte du rang immédiatement supérieur et de couleur opposée (par ex. un 7 noir peut être placé sur un 8 rouge).
    *   **Déplacer vers les fondations :** dès qu'un As devient disponible, déplace-le vers une pile de fondation. Continue à déplacer les cartes de la même couleur en ordre croissant (As, 2, 3, 4...) vers les piles de fondation dès que possible.
