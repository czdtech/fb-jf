...
2.  **Deploy Your Army:** Drag your strongest heroes from the reserve board onto the battle grid. Once placed, they will automatically engage any enemies that come within their range. You have a limited number of slots on the battle grid, so choose your active heroes wisely.
3.  **Hero Types:** Pay attention to different hero types. Melee heroes (like knights) must be on the front lines to engage enemies, while ranged heroes (like archers) can attack from the back. A balanced formation is key.
4.  **Manage Your Gold:** You earn gold automatically as your heroes defeat monsters. Reinvest this gold quickly into buying more basic heroes so you can continue merging and upgrading your army to keep up with the increasingly difficult enemy waves.
