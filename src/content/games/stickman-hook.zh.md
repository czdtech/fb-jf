...
title: '[ZH TRANSLATION NEEDED] Stickman Hook'
description: >-
  [ZH TRANSLATION NEEDED] Stickman Hook is a physics-based swinging game where
  players control a stickman character, using grappling hooks to swing through
  levels, avoiding obstacles and performing acrobatic moves to reach the finish
  line.
