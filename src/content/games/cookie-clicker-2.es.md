...
title: '[ES] Cookie Clicker 2'
description: >-
  [ES] The definitive guide for Cookie Clicker, the legendary incremental game.
...
*   **[ES]** **Initial Clicks**: Start by manually clicking the cookie until you can afford your first Cursor.
*   **[ES]** **Buy Buildings**: Continuously buy the cheapest, most effective building available. A good strategy is to buy one of each building type as you unlock them to see what upgrades become available.
*   **[ES]** **CLICK THE GOLDEN COOKIES**: This is the most important tip. A golden cookie will randomly appear on screen every few minutes. Clicking it grants a powerful, temporary bonus (like "Frenzy," which multiplies your CpS by 7, or "Click Frenzy," which multiplies your click power by 777). These are essential for rapid progress.
*   **[ES]** **Buy Upgrades**: As soon as an upgrade appears in the store, try to buy it. They provide significant percentage-based boosts to your CpS.

**2. Mid Game (Preparing for Ascension):**
*   **[ES]** **What is Ascension?**: Ascension is the game's prestige mechanic. You can choose to reset your game (losing your cookies, buildings, and upgrades) in exchange for Heavenly Chips and Prestige Levels. Each Prestige Level gives a permanent +1% boost to your CpS for all future playthroughs.
*   **[ES]** **When to Ascend First**: The most common advice is to ascend for the first time when you have accumulated **200-440** Prestige Levels. Ascending too early is inefficient. You can see your potential prestige level in the "Stats" menu under "Legacy."
*   **[ES]** **Spending Heavenly Chips**: After ascending, you enter a new screen where you can spend your Heavenly Chips on powerful, permanent celestial upgrades. For your first ascension, focus on upgrades like "Persistent memory," "How to bake your dragon," and the "Cookie box" upgrades.

**3. Late Game (Efficient Runs & Minigames):**
*   **[ES]** **The Loop**: The late game consists of repeating the cycle: start a new run, buy buildings and upgrades quickly, leverage Golden Cookie combos (e.g., getting a "Frenzy" and a "Click Frenzy" at the same time for a massive boost), push as far as you can, and ascend again for more Prestige.
*   **[ES]** **The Grandmapocalypse**: Researching specific "Bingo center" upgrades will trigger the Grandmapocalypse. This changes the game's appearance and replaces Golden Cookies with "Wrath Cookies," which have a chance of giving negative effects. It's a strategic choice: you can either embrace it for its unique rewards or pay to appease the grandmas and end it.
*   **[ES]** **Minigames**: As you level up certain buildings with Sugar Lumps, you unlock complex minigames (the Garden, the Pantheon, the Grimoire). Mastering these provides huge long-term bonuses but requires active management.
*   **[ES]** **Sugar Lumps**: You get one Sugar Lump about every 24 hours. These can be used to level up your buildings, with each level granting a permanent +1% CpS bonus to that building type. Use them wisely.

### **Controls Guide**

The game is controlled almost entirely with the mouse, but a few key interface elements are important.

*   **[ES]** **Mouse Click**: Click the big cookie, Golden Cookies, upgrades, and buildings.
*   **[ES]** **Buy/Sell Toggles**: At the top of the store, you can toggle between buying **1, 10, or 100** of a building at a time. Using the "Buy 100" toggle is essential for efficiency in the late game.
*   **[ES]** **Keyboard Shortcuts**:
    *   **[ES]** **CTRL + SHIFT + Click**: Buys 10 of a building/upgrade.
    *   **[ES]** **CTRL + Click**: Buys 100 of a building/upgrade.
    *   **[ES]** **SHIFT + Click**: Buys 1000 of a building/upgrade.
