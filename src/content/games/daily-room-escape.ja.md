...
- Q: 暗号が正解のはずなのに開きません。
  ...
  A: 手がかりの順番や方向（上下左右）が逆になっていることがあります。矢印や並び順のヒントをもう一度確認してください。

<!-- i18n:faq:id=faq:daily-room-escape:items-dont-combine-2256ff0c -->
- Q: アイテムが組み合わせられません。
  
  A: 先に特定のアイテムを選択してから別のアイテムを使う必要がある場合があります。アイテムを詳細表示して隠し部品がないかも確認しましょう。

<!-- i18n:faq:id=faq:daily-room-escape:too-dark-to-see-3ece7f99 -->
- Q: 画面が暗くて見えません。
  
  A: 端末の明るさを上げるか、ゲーム内に照明/懐中電灯アイテムがある場合は入手・使用してみてください。
