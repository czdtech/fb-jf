...
title: '[KO] One line only: dot to dot'
description: >-
  [KO] One line only: dot to dot is a neat one‑stroke puzzler — draw a single
...
1.  **[KO]** Degree count: Start at odd‑degree nodes (0 or 2 exist for Euler trails); they suggest endpoints.
2.  **[KO]** Bridge first: Draw mandatory bridges early so you don’t lock them out later.
3.  **[KO]** Avoid isolating: Don’t complete loops that strand unvisited edges.
4.  **[KO]** Look‑ahead: Test two moves mentally; backtrack early when isolation appears.
5.  **[KO]** Symmetry: Use symmetrical halves to mirror partial routes.
