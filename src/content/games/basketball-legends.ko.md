...
seoTitle: Basketball Legends 농구 레전드 무료 온라인 플레이 | FiddleBops
description: >-
...
### 조작 방법
<!-- i18n:controls:keys -->
- 키(정렬)： `A` `D` `tap` `A` `D` `B` `S` `W` `V` `Left` `Right Arrow` `tap` `Left` `Right Arrow` `L` `Down Arrow` `Up Arrow` `K`

한 키보드에서 두 명이 동시에 플레이하도록 설계된 조작 체계를 사용합니다.

#### 플레이어 1
*   이동: A, D 키
*   대시: A 또는 D를 두 번 빠르게 입력
*   슛/덩크: B 키
*   펌프/스틸: S 키
*   점프: W 키
*   슈퍼샷: V 키
