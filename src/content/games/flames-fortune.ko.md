...
title: '[KO] Flames & Fortune'
description: >-
  [KO] Flames & Fortune is a tactical card‑style battler — manage hands, trade
...
1.  **[KO]** Curve planning: Spend your turn’s resources cleanly; avoid floating energy.
2.  **[KO]** Value trades: Use small cards to set up big swings next turn.
3.  **[KO]** Read intents: Counter incoming damage with blocks or denies.
4.  **[KO]** Deck focus: Prioritize consistent synergies over scattered picks.
5.  **[KO]** Mulligan wisely: If available, mulligan slow hands against fast foes.
