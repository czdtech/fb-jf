...
locale: zh
urlstr: bloons-td-3
title: '[ZH TRANSLATION NEEDED] Bloons TD 3'
description: >-
  [ZH TRANSLATION NEEDED] Defend against waves of colorful bloons in Bloons TD
...
[ZH TRANSLATION NEEDED] The game uses a simple and intuitive point-and-click interface.
...
[ZH TRANSLATION NEEDED] **1. I can't pop the grey (Lead) Bloons! What do I do?**
[ZH TRANSLATION NEEDED] > Lead Bloons are immune to all sharp projectiles (darts, tacks, boomerangs). You must use a Bomb Tower to pop them.

[ZH TRANSLATION NEEDED] **2. What is the big blue blimp at the end of the game?**
[ZH TRANSLATION NEEDED] > That is the M.O.A.B. (Massive Ornary Air Blimp). It is a very durable boss Bloon. It moves slowly but can absorb a lot of damage before it pops.

[ZH TRANSLATION NEEDED] **3. Why should I use the Monkey Beacon? It doesn't attack.**
[ZH TRANSLATION NEEDED] > The Monkey Beacon is a support tower. It provides a crucial range boost to all towers placed near it. A Super Monkey next to a Beacon can cover almost the entire map, making it far more effective.

[ZH TRANSLATION NEEDED] **4. How many rounds are there?**
[ZH TRANSLATION NEEDED] > -   **Easy Difficulty:** 50 rounds.
[ZH TRANSLATION NEEDED] > -   **Medium Difficulty:** 50 rounds.
[ZH TRANSLATION NEEDED] > -   **Hard Difficulty:** 75 rounds.

[ZH TRANSLATION NEEDED] **5. What's the difference between Black and White Bloons?**
[ZH TRANSLATION NEEDED] > Black Bloons are immune to explosions (from Bomb Towers). White Bloons are immune to being frozen (by Ice Towers). You need other towers like Dart Monkeys or Boomerangs to handle them.
