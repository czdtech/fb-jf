...
- Q: 最後の一つが見つかりません！どうすればいいですか？
  
  A: 一歩引いて全体を眺めるか、逆に拡大して端や繰り返し模様、影などを重点的に見直しましょう。それでも見つからない時はヒントが有効です。

<!-- i18n:faq:id=faq:differences-find-quest:do-i-lose-time-for-7a46e512 -->
- Q: お手つき（ミスタップ）でペナルティはありますか？
  
  A: 多くのモードでは、誤タップで時間やスコアが減ります。確信がある場所を狙ってタップしましょう。

<!-- i18n:faq:id=faq:differences-find-quest:any-trick-for-tiny-color-3d274161 -->
- Q: 色の違いが分かりにくいです。
  
  A: 画面の明るさを上げたり、少し目を細める/ズームすることで、微妙なコントラスト差が見えやすくなることがあります。
