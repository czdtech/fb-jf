...
- **Selection:** `Click` or `Tap` characters to preview sounds.
- **Placement:** `Drag` and `Drop` characters onto the stage slots to activate them.
- **Mute/Solo:** `Click` active characters to toggle mute or solo modes.

<!-- i18n:section:faq -->
### Frequently Asked Questions (FAQ)

- <!-- i18n:faq:id=faq:ayocs-sprunkr:is-it-free-9d8e3b2a -->
  **Is AYOCS Sprunkr free?** Yes, it is a free mod available to play online.
- <!-- i18n:faq:id=faq:ayocs-sprunkr:mobile-compatible-2a8d3c4e -->
  **Can I play on mobile?** Yes, the game is optimized for both desktop and mobile browsers.
