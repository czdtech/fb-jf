...
const canonicalRaw = fs.readFileSync('src/content/games/incredibox-kochari.md', 'utf-8');
...
console.log('Canonical nodes 12-17:');
canonicalNodes.slice(12, 18).forEach((n, i) => {
  console.log(`${i+12}:`, n);
});

console.log('\nLocalized nodes 12-17:');
localizedNodes.slice(12, 18).forEach((n, i) => {
  console.log(`${i+12}:`, n);
});
