...
const canonicalFile = fs.readFileSync('src/content/games/3-tricky-quests.en.md', 'utf-8');
const jaFile = fs.readFileSync('src/content/games/3-tricky-quests.ja.md', 'utf-8');
