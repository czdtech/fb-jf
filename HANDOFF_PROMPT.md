...
- **ES**：679/679（100%）✅
- **JA**：679/679（100%）✅
- **FR**：150/679（22.09%）🚧（已审校 slug：`2-tricky-stories` → `football-penalty`）
- **DE**：0/679（0%）
...
### 法语 FR：下一批（B16，10 篇，字典序）

`football-stars`, `footchinko`, `freekick-football`, `friday-night-funkin`, `fruit-chef`, `fruit-chopper`, `fruit-cube-blast`, `fruit-ninja`, `fruit-slot-machine`, `fullspeed-racing`
